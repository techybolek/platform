...
import org.wso2.carbon.bps.util.BPSMgtUtils;
import org.wso2.carbon.bps.util.FrameworkSettings;
import org.wso2.carbon.bps.util.HumanTaskAdminServiceUtils;
import org.wso2.carbon.bps.util.HumanTaskTestConstants;
...
public class HumanTaskCreationTestCase extends BPSMasterTest {
    ...
    FrameworkSettings.HTTPS_PORT + File.separator + "services" + File.separator;
    ...
    protected void initialize() throws Exception {
        ...
        userAdminStub = HumanTaskAdminServiceUtils.getUserAdminStub(environment.getBackEndUrl());
        addRoles();
        addUsers();
    ...
    public void deployArtifact()
        ...
        requestSender.waitForProcessDeployment(serviceUrl + File.separator + "ClaimsApprovalProcessService");
    }
    ...
    private void addUsers()
        ...
        FlaggedName[] managerUsers = userAdminStub.getUsersOfRole(HumanTaskTestConstants.REGIONAL_MANAGER_ROLE,
                "manager*", 1);
        assertTrue(managerUsers.length == 2,
    ...
    public void createFirstTask() throws Exception {
        ...
        requestSender.sendRequest(SERVICE_URL_PREFIX + serviceName, operation, soapBody, 1,
                expectedOutput, true);
    ...
    public void testSimpleTaskQuery() throws Exception {
        ...
        Assert.assertEquals(rows.length, 2, "There should be 3 tasks from the query");
    }
    ...
    public void removeArtifacts()
        ...
        bpelManager.undeployBPEL("ClaimsApprovalProcess");
