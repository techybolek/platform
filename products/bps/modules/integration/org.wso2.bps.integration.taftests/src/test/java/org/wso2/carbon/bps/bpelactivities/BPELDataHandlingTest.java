...
public class BPELDataHandlingTest extends BPSMasterTest{
    ...
    public void deployArtifact()
        ...
        requestSender.waitForProcessDeployment(serviceUrl + File.separator + "XMLAttributeProcessService");
    }
    ...
    public void flexibleAssign() throws XMLStreamException, AxisFault {
        ...
        String serviceName = File.separator + "FlexibleAssign";
    ...
    public void ignoreMissingFromData() throws XMLStreamException, AxisFault {
        ...
        String serviceName = File.separator + "TestIgnoreMissingFromDataService";
    ...
    public void combineUrl() throws XMLStreamException, AxisFault {
        ...
        String serviceName = File.separator + "TestCombineUrlService";
    ...
    public void expandTemplateWithElement()
        ...
        String serviceName = File.separator + "TestExpandTemplateService";
    ...
    public void assignActivity1() throws XMLStreamException, AxisFault {
        ...
        String serviceName = File.separator + "TestAssignService";
    ...
    public void assignDate() throws XMLStreamException, AxisFault {
        ...
        String serviceName = File.separator + "TestAssignDateService";
    ...
    public void XSLTransform() throws XMLStreamException, AxisFault {
        ...
        String serviceName = File.separator + "HelloXslService";
    ...
    public void split() throws AxisFault, XMLStreamException {
        ...
        String serviceName = File.separator + "TestSplitService";
    ...
    public void counter() throws AxisFault, XMLStreamException {
        ...
        String serviceName = File.separator + "counterService";
    ...
    public void processProperty() throws Exception {
        ...
        String serviceName = File.separator + "XMLAttributeProcessService";
    ...
    public void removeArtifacts()
        ...
        bpelManager.undeployBPEL("FlexibleAssign");
        bpelManager.undeployBPEL("TestIgnoreMissingFromData");
        bpelManager.undeployBPEL("TestCombineUrl");
        bpelManager.undeployBPEL("TestExpandTemplate");
        bpelManager.undeployBPEL("TestAssignActivity1");
        bpelManager.undeployBPEL("TestAssignDate");
        bpelManager.undeployBPEL("TestXslTransform");
        bpelManager.undeployBPEL("TestCounter");
        bpelManager.undeployBPEL("TestSplit");
        bpelManager.undeployBPEL("TestXslTransform");
        bpelManager.undeployBPEL("XMLAttributeProcess");
