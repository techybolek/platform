...
public class BPELMessageRoutingTest extends BPSMasterTest{
    ...
    public void deployArtifact()
        ...
        requestSender.waitForProcessDeployment(serviceUrl + File.separator + "MyRoleMexTestProcessService");
    }
    ...
    private void correlationOpaqueInitFoo()
        ...
        String serviceName = File.separator + "counterService2";
    ...
    private void myRoleMEXRetention() throws Exception {
        ...
        String operation = "init";
        String serviceName = File.separator + "MyRoleMexTestProcessService";
        List<String> expectedOutput = new ArrayList<String>();
    ...
    public void removeArtifacts()
        ...
        bpelManager.undeployBPEL("TestCorrelationUnique");
        bpelManager.undeployBPEL("MyRoleMexTestProcess");
