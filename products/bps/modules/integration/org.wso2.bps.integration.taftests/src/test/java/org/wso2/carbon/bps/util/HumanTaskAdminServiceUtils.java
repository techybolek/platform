package org.wso2.carbon.bps.util;
/*
...
public class HumanTaskAdminServiceUtils {
    public static UserAdminStub getUserAdminStub(String backEndUrl) throws Exception {
        ...
        LoginLogoutUtil util = new LoginLogoutUtil(FrameworkSettings.HTTPS_PORT, "localhost");
        String loggedInSessionCookie = util.login("admin", "admin", backEndUrl);
    ...
    public static InstanceManagementServiceStub getInstanceManagementServiceStub()
        ...
        ClientConnectionUtil.waitForPort(FrameworkSettings.HTTPS_PORT, "localhost");
