...
public class BPELMultiUploadTest extends BPSMasterTest {
    ...
    private BpelPackageManagementClient bpelManager;
    ...
    public void copyArtifacts() throws InterruptedException, RemoteException, PackageManagementException {
