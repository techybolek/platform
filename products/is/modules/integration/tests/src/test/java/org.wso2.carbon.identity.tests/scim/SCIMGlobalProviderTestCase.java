...
import org.wso2.carbon.identity.tests.scim.MasterSCIMInitiator;
...
public class SCIMGlobalProviderTestCase extends MasterSCIMInitiator {
    ...
    @Test(alwaysRun = true, description = "Delete user for consumer and assert on provider", priority = 3)
    @SetEnvironment(executionEnvironments = {ExecutionEnvironment.integration_all})
