...
public class PostInitializer implements ServletContextListener{
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		log.debug("App factory post initilization invoked when initializing the context.");
		...
		try {
			...
			if(tenantHome == null){
				String erroMsg = JenkinsTenantConstants.JENKINS_TENANT_HOME + " is not set or not pointed to valid location.";
				log.fatal(erroMsg);
	...
	public void contextDestroyed(ServletContextEvent event) {
		log.debug("App factory post initilization invoked when detroying the context.");		
	}
}
