...
<div class="container-fluid">
    <div class="row-fluid">
		...
		<div class="well topFilteringPanel"><span class="span3">Select Server :
            ...
            <div class="row-fluid">
                <div class="hero-unit">
                    <iframe id="dashboardWidget-3" src="gadgets/psEdenSpace.jag?t=Now" class="single-column-gadget"></iframe>
                </div>
            </div>
            <div class="row-fluid">
                <div class="hero-unit">
                    <iframe id="dashboardWidget-4" src="gadgets/permGen.jag?t=Now" class="single-column-gadget"></iframe>
                </div>
            </div>
            <div class="row-fluid">
                <div class="hero-unit">
