  ...
  <div class="row-fluid">
    <div class="span2">
      <div class="well sidebar-nav">
        <ul id="leftnav" class="nav nav-list">
          ...
          <!--<li><a href="#" style="color: #cccccc;cursor:default ">ESB Mediation Statistics</a></li>
          <li><a href="#" style="color: #cccccc;cursor:default">ESB Activity Statistics</a></li>
    ...
    <div class="span10">
      <div class="well topFilteringPanel"><span class="span3">Select Server :
          ...
          <span class="span3">Select Tenant :
          <select id="service-dd" name="basic-combo">
			     <option value="__default__"></option>
		</select></span>
          <span class="span3">Select Appliction :
      ...
      <div class="row-fluid">
        ...
        <div class="row-fluid">
        <div class="hero-unit">
            <iframe id="dashboardWidget-5" class="single-column-gadget" src="gadgets/session.bar.chart.jag?server=&service&opr&t=Now"></iframe>
        </div>
        </div>
        <div class="row-fluid">
            <div class="hero-unit">
                <iframe id="dashboardWidget-6" class="single-column-gadget" src="gadgets/average.session.time.bar.chart.jag?server=&service&opr&t=Now"></iframe>
            </div>
        </div>
        <div class="row-fluid">
            <div class="hero-unit">
                <iframe id="dashboardWidget-7" class="single-column-gadget" src="gadgets/contextTableDataRetriever.jag?server=&service&opr&t=Now"></iframe>
            </div>
        </div>
    </div><!--/span-->
  </div><!--/row-->
