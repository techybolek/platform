    ...
    <div class="span10">
        <div class="well topFilteringPanel">
            ...
            <div id="time-selectors">
                <span class="span6">
                    <div class="row-fluid"><span class="span4"> <label class="badge">From</label> </span> </div>
                    <div class="row-fluid">
                        <span class="span3">
                            <span class="control-label" for="from-date">Date :</span> <br />
                                                            <input type="text" id="from-date" class="input-small datepicker"></input>
                        </span>
                        <span class="span3">
                            <span class="control-label" for="from-time">Time :</span>    <br />
                                                            <input type="text" id="from-time" class="input-small timepicker"></input>
                        </span>
                    </div>
                </span>
                <span class="span6">
                    <div class="row-fluid"><span class="span4"> <label class="badge">To</label> </span> </div>
                    <div class="row-fluid">
                        <span class="span3">
                            <span class="control-label" for="to-date">Date :</span>     <br />
                                                            <input type="text" id="to-date" class="input-small datepicker"></input>
                        </span>
                        <span class="span3">
                            <span class="control-label" for="to-date">Time :</span>     <br />
