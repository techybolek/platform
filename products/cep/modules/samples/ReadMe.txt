...
There are basic samples given to try how CEP 3.0.0 works with different event adaptors and mappings..
...
2) Here with the CEP 3.0.0 alpha-2 pack, there are 7 samples given...
