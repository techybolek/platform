package org.wso2.carbon.integration.test.webapp.faultywebapp;
...
public class FaultyWebAppScenarioTestCase extends ASIntegrationTest {
    ...
    public void faultyWebAppDeployment() throws Exception {
        ...
        WebappMetadata[] webAppMetadata =
                webAppAdminClient.getPagedFaultyWebappsSummary("", "", 1).getWebapps();
    ...
    public void nonWarUpload() throws Exception {
        ...
        assertFalse(WebApplicationDeploymentUtil.isWebApplicationDeployed(asServer.getBackEndUrl(),
                asServer.getSessionCookie(), "AxisCApp-1.0.0"));
    }
    ...
    public void alreadyUploadedWarFileUpload() throws Exception {
        ...
        assertTrue(WebApplicationDeploymentUtil.isWebApplicationDeployed(asServer.getBackEndUrl(),
                asServer.getSessionCookie(), "appServer-valied-deploymant-1.0.0"),
    ...
    public void faultyWebAppErrorRectifiedRedeploy() throws Exception {
        ...
        String rectifiedWebAppLocation = ProductConstant.SYSTEM_TEST_RESOURCE_LOCATION +
                "artifacts" + File.separator + "AS" + File.separator + "war" +
                File.separator + "SimpleServlet.war";
        webAppAdminClient.warFileUplaoder(rectifiedWebAppLocation);   // uploading the web app
        assertTrue(WebApplicationDeploymentUtil.isWebApplicationDeployed(asServer.getBackEndUrl(),
                asServer.getSessionCookie(), "SimpleServlet"),
