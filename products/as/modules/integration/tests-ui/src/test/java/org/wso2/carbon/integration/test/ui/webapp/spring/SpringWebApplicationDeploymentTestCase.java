...
*under the License.
*/
package org.wso2.carbon.integration.test.ui.webapp.spring;
...
import org.wso2.carbon.automation.api.selenium.webapp.WebAppUploadingPage;
 ...
 */
public class SpringWebApplicationDeploymentTestCase extends ASIntegrationUiTestCase {
    ...
    @Test(groups = "wso2.as", description = "Uploading the web app which use spring")
    public void uploadSpringWebApplicationTest() throws Exception {
        String filePath = ProductConstant.getResourceLocations(ProductConstant.APP_SERVER_NAME)
    ...
    @Test(groups = "wso2.as", description = "Verifying Deployment the web app which use spring"
            , dependsOnMethods = "uploadSpringWebApplicationTest")
