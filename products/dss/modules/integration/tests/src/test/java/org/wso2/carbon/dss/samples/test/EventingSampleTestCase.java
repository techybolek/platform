...
public class EventingSampleTestCase extends DSSIntegrationTest {
    private static final Log log = LogFactory.getLog(GSpreadSampleTestCase.class);

    private static String serviceName = "EventingSample";
    private static final String GMAIL_USER_NAME = "test.automation.dummy";
    private static final String GMAIL_PASSWORD = "test.automation";
