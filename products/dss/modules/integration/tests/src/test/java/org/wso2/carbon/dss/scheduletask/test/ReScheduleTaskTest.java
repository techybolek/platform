...
package org.wso2.carbon.dss.scheduletask.test;

import org.testng.annotations.AfterClass;
import org.testng.annotations.BeforeClass;
import org.wso2.carbon.automation.api.clients.dataservices.DataServiceTaskClient;
...
public class ReScheduleTaskTest extends DSSIntegrationTest {
    ...
    public void initialize() throws Exception {
        ...
        String resourceLocation = ProductConstant.SYSTEM_TEST_RESOURCE_LOCATION + "artifacts"
                                  + File.separator + "DSS";
        ...
        serviceEndPoint = dssServer.getBackEndUrl() + serviceName;

        dssTaskClient = new DataServiceTaskClient(dssServer.getBackEndUrl(), userInfo.getUserName(),
    ...
    @Test(groups = "wso2.dss", dependsOnMethods = {"startScheduleTask"},
          description = "Task repeat count set to zero - This method has been added to avoid task repetition")
    ...
    @Test(groups = "wso2.dss", dependsOnMethods = {"testSetRepeatCountToZero"}, description = "reschedule the task")
    ...
    @Test(groups = "wso2.dss", dependsOnMethods = {"reScheduleTask"},
          description = "Check whether the task has been stopped properly")
    ...
    @Test(groups = "wso2.dss", dependsOnMethods = {"stopScheduleTask"}, description = "Recheck the task invocation")
