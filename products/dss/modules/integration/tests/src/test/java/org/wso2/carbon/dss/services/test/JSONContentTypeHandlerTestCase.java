...
import org.wso2.carbon.automation.utils.generic.GenericJSONClient;
...
public class JSONContentTypeHandlerTestCase extends DSSIntegrationTest {
    ...
    private void listProducts(String contentType) throws Exception {
        ...
        JSONObject result = jsonClient.doGet(this.getServiceEndpoint() + "_getproducts", "",
                contentType);
    ...
    private void getProductByCode(String producCode) throws Exception {
        ...
        JSONObject result = jsonClient.doGet(
                this.getServiceEndpoint() +
                        "_getproduct_productcode/=?{\"_getproduct_productcode\":{\"productCode\":\"N10_1671\"}}",
                "", "application/json");
        Assert.assertNotNull(result, "Response is null");
