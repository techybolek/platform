...
public class ResourceHandlingTestCase {
    ...
    public void getResourceOperationTest() throws RegistryException {
        ...
        assertEquals(r3.getAuthorUserName(), userInfo.getUserName(), "Author names are not Equal");

        r3 = registry.get(path);

        assertEquals(r3.getAuthorUserName(), userInfo.getUserName(), "Author User names are not Equal");
        ...
        assertEquals(r3.getLastUpdaterUserName(), userInfo.getUserName(), "Last Updated names are not Equal");
