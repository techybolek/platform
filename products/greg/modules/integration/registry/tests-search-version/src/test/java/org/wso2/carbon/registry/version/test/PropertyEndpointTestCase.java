...
public class PropertyEndpointTestCase {
    ...
    public void initializeRegistry()
        ...
        Assert.assertTrue(resourceAdminClient.getResource(PATHROOT)[0].getAuthorUserName().contains(userInfo.getUserNameWithoutDomain()));
    }
    ...
    public void testVersionAssociation()
        ...
        relationAdminServiceClient.addAssociation(PATH_CONSTANT + endpoint.getPath(), "usedBy", PATHROOT, "add");
    ...
    public void testVersionDependency()
            throws ResourceAdminServiceExceptionException, RemoteException, GovernanceException,
                   AddAssociationRegistryExceptionException {
        relationAdminServiceClient.addAssociation(PATH_CONSTANT + endpoint.getPath(), "depends", PATHROOT, "add");
