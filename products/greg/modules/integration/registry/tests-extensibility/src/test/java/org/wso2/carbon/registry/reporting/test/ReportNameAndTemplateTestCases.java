...
public class ReportNameAndTemplateTestCases extends ReportingTestCaseSuper {
    ...
    @BeforeClass
    public void initializeForTesting() throws RemoteException, RegistryException,
                                              LoginAuthenticationExceptionException {
        applicationName = super.applicationName + "ReportNameAndTemplateTestCases";
        artifactName = super.artifactName + "ReportNameAndTemplateTestCases";
        init();
    }
     ...
     * @throws Exception
     */
    @Test(groups = "wso2.greg", description = "Add Report with a name which contains special characters", expectedExceptions = java.lang.Exception.class, dependsOnMethods = "testSaveReportNameWhichExist")
     ...
     * @throws Exception
     */
    @Test(groups = "wso2.greg", description = "Delete and Add Report with different configuration", dependsOnMethods = "testFieldMismatch")
