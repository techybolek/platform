...
public class WSDLTestClientCase {
    ...
    public void testWsdlWithInlinePolicyAndSchema() throws GovernanceException {
        ...
        Wsdl wsdl;
        try {
            wsdl = wsdlManager.newWsdl("https://svn.wso2.org/repos/wso2/carbon/platform/" +
                    "trunk/platform-integration/system-test-framework/core/org.wso2.automation.platform.core/" +
                    "src/main/resources/artifacts/GREG/wsdl/WithInlinePolicyAndSchema.wsdl");
            wsdlManager.addWsdl(wsdl);
        } catch (GovernanceException e) {
