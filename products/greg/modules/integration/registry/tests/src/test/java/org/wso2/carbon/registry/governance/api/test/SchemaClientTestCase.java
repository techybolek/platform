...
public class SchemaClientTestCase{
    ...
    public void testInvalidSchema() {
        ...
        try {
            schema = schemaManager.newSchema("https://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                    "platform-integration/clarity-tests/org.wso2.carbon.automation.test.repo/src/main/" +
                    "resources/artifacts/GREG/schema/XmlInvalidSchema.xsd");
            schemaManager.addSchema(schema);
