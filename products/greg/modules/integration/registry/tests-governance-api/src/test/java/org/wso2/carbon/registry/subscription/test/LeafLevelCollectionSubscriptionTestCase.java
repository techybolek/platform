...
public class LeafLevelCollectionSubscriptionTestCase {
    ...
    public void testConsoleSubscription() throws Exception {
        assertTrue(ManagementConsoleSubscription.init(COLLECTION_PATH, "CollectionUpdated",
    ...
    public void clean() throws RegistryException, RegistryExceptionException, IOException,
        ...
        InfoServiceAdminClient infoServiceAdminClient = new InfoServiceAdminClient(
        ...
        SubscriptionBean sBean =
                infoServiceAdminClient.getSubscriptions(COLLECTION_PATH, sessionID);
        infoServiceAdminClient.unsubscribe(COLLECTION_PATH,
