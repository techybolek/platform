...
public class ServiceVersionTestForLCs {
    ...
    public void init()
        ...
        searchAdminService = new SearchAdminServiceClient(environment.getGreg().getProductVariables().getBackendUrl(),
                                                          environment.getGreg().getSessionCookie());

        userManger = new UserManagementClient(environment.getGreg().getProductVariables().getBackendUrl(),
                                              environment.getGreg().getSessionCookie());
    ...
    private void addRole(String roleName) throws Exception {
        ...
        userManger.addRole(roleName, new String[]{userInfo.getUserNameWithoutDomain()}, permissions);
