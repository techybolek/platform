...
public class WsdlTagsVerificationTestCase {
    ...
    public void testTagsVerification()
        ...
        infoServiceAdminclient.addTag("my tag", wsdlPath, environment.getGreg()
                .getSessionCookie());
        wsdlManager.updateWsdl(wsdl);
        TagBean tagBean = infoServiceAdminclient.getTags(wsdlPath, environment
