 ...
 */
public class UDDIOSBIntegrationTestCase {
    ...
    private void initJuddi() {
        try {
            String uddi_path = ProductConstant.SYSTEM_TEST_RESOURCE_LOCATION + "artifacts" + File.separator +
                          "GREG" + File.separator +
                          "xml" + File.separator + "simple-publish-uddi.xml";
...
//
            ...
            accessPoint.setValue("http://svn.wso2.org/repos/wso2/carbon/platform/trunk/components/governance/org.wso2.carbon.governance.api/src/test/resources/test-resources/wsdl/BizService.wsdl");
