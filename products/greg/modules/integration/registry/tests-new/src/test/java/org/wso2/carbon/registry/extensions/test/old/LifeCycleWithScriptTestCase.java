...
public class LifeCycleWithScriptTestCase {
    ...
    private final static String ASPECT_NAME = "IntergalacticServiceLC";
    ...
    public void createNewLifeCycle()
        ...
        String filePath =
                ProductConstant.SYSTEM_TEST_RESOURCE_LOCATION + "artifacts" +
                        ...
                        File.separator + "lcWithScript2.xml";
    ...
    public void addLifeCycleToService() throws ResourceAdminServiceExceptionException, RemoteException, RegistryException, CustomLifecyclesChecklistAdminServiceExceptionException, InterruptedException {
    ...
    @AfterClass
    public void deleteLifeCycle() throws LifeCycleManagementServiceExceptionException, RemoteException, RegistryException, ResourceAdminServiceExceptionException {
     ...
     *
     * @throws org.wso2.carbon.governance.services.stub.AddServicesServiceRegistryExceptionException
     *
     */
