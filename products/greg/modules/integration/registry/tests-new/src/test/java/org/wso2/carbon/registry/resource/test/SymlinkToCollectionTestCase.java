...
public class SymlinkToCollectionTestCase {
    ...
    public void testAddResourceToCollection()
        ...
        assertTrue(userInfo.getUserNameWithoutDomain().equalsIgnoreCase(authorUserName), "Adding resource to the collection failed");
    ...
    public void testRenameResourceInSymlink()
            throws ResourceAdminServiceExceptionException, RemoteException {
        resourceAdminClient.renameResource(
                SYMLINK_LOC + SYMLINK_NAME, SYMLINK_LOC + SYMLINK_NAME + "/" + RES_NAME, RES_NAME_AFTER_RENAME);
    ...
    public void testCopiedSymlinkStatus()
            throws ResourceAdminServiceExceptionException, RemoteException {
