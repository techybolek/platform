...
public class InvalidGARAdditionTestCase {
    ...
    public void initialize() throws RemoteException,
        ...
        int userId = 2;
        EnvironmentBuilder builder = new EnvironmentBuilder().greg(2);
     ...
     * exception
     */
    @Test(groups = "wso2.greg", description = "Add Invalid GAR", expectedExceptions = GovernanceException.class)
     ...
     * exception
     */
    @Test(groups = "wso2.greg", description = "invalid wsdl form file system using admin services", expectedExceptions = AxisFault.class, dependsOnMethods = "testAddInvalidGAR")
