...
public class UpdateNotificationEventTypeCollectionTestCase {
    ...
    public Object[][] sdp() {
        return new Object[][]{new Object[]{ROOT},
                              new Object[]{LEAF_COLLECTION_PAH + COLLECTION_NAME},
    ...
    public void initialize() throws RemoteException, LoginAuthenticationExceptionException,
        ...
        relationAdminServiceClient =
                new RelationAdminServiceClient(
                        environment.getGreg()
                                .getProductVariables()
                                .getBackendUrl(),
                        userInfo.getUserName(),
    ...
    public void testAddRootCollection() throws MalformedURLException, RemoteException,
                                               ResourceAdminServiceExceptionException {
    ...
    public void testAddLeafCollection() throws MalformedURLException, RemoteException,
                                               ResourceAdminServiceExceptionException {
        resourceAdminServiceClient.addCollection(LEAF_COLLECTION_PAH, COLLECTION_NAME, "other",
                                                 "test collection");
        String authorUserName =
                resourceAdminServiceClient.getResource(LEAF_COLLECTION_PAH +
                                                       COLLECTION_NAME)[0].getAuthorUserName();
        assertTrue(userInfo.getUserNameWithoutDomain().equalsIgnoreCase(authorUserName),
                   "Leaf level collection creation failure");
    }
    ...
    @Test(groups = "wso2.greg", description = "Get Management Console Notification", dependsOnMethods = {
            "testAddRole"}, dataProvider = "SubscriptionPathDataProvider")
    public void testConsoleSubscription(String path) throws Exception {
        ...
        SubscriptionBean bean =
                infoServiceAdminClient.subscribe(path,
    ...
    public void testAddComment(String path) throws AddAssociationRegistryExceptionException,
    ...
    public void testAddDependency(String path) throws RemoteException,
        ...
        for (AssociationBean associationBean : assBeans) {
            if (dependencyType.equals(associationBean.getAssociationType())) {
                ...
                success =
                        success &&
                        (ROOT + RESOURCE_NAME).equalsIgnoreCase(associationBean.getDestinationPath());
    ...
    public void testAddAssociation(String path) throws RemoteException,
                                                       AddAssociationRegistryExceptionException {
        ...
        AssociationTreeBean aTreeBean =
                relationAdminServiceClient.getAssociationTree(path,
                                                              "association");
        assertTrue(aTreeBean.getAssociationTree().contains(ROOT + RESOURCE_NAME),
    ...
    public void testGetNotifications(String path) throws RemoteException,
        ...
        for (WorkItem workItem : workItems) {
            if (workItem.getPresentationSubject().toString()
                ...
                notiTag = true;
            } else if (workItem.getPresentationSubject().toString()
                    .contains("A rating of 1 was given to the collection at " + path)) {
                notiRate = true;
            } else if (workItem.getPresentationSubject()
                    .toString()
                    .contains("A comment was added to the collection at " + path +
