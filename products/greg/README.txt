 ...
 * Lifecycle configuration enhancements (Approval functionality for lifecycle operations)
 * Registry extensions (RXT) enhancements 
   - Regex validations for RXT fields
   - Tooltips for RXT fields
   - Date field for RXTs
   - RXT management UI
   - RXT hot deployment capability
 * Aggregate download for resources and governance artifacts
 * Checkin client improvements
