...
public class AddressEndpointTestCase extends ESBIntegrationTest {
    ...
    public void testSendingToInvalidPropertyAddressEndpoint()
        ...
        ProxyServiceAdminClient proxyAdmin = new ProxyServiceAdminClient(esbServer.getBackEndUrl(), esbServer.getSessionCookie());
    ...
    @Test(groups = {"wso2.esb"}, description = "Adding Duplicate Address endpoint", expectedExceptions = org.apache.axis2.AxisFault.class)
