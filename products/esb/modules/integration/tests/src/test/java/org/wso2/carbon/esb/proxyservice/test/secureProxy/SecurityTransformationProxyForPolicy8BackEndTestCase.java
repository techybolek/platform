...
public class SecurityTransformationProxyForPolicy8BackEndTestCase extends ESBIntegrationTest {
    ...
    public void setEnvironment() throws Exception {
        ...
        ResourceAdminServiceClient resourceAdmin = new ResourceAdminServiceClient(esbServer.getBackEndUrl()
    ...
    public void securityPolicy1() throws Exception {
        ...
        OMElement response;
        for (int i = 0; i < 5; i++) {
            response = secureAxisServiceClient.sendSecuredStockQuoteRequest(userInfo, getProxyServiceSecuredURL(serviceName), policyId, symbol);
    ...
    public void securityPolicy2() throws Exception {
        ...
        OMElement response;
        for (int i = 0; i < 5; i++) {
            response = secureAxisServiceClient.sendSecuredStockQuoteRequest(userInfo, getProxyServiceURL(serviceName), policyId, symbol);
            verifyResponse(response);
        }
