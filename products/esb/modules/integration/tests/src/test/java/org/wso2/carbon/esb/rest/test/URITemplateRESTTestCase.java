...
package org.wso2.carbon.esb.rest.test;
 ...
 * This test class test the Rest URI template patterns like uri-template="/view/{symbol}"
 */
public class URITemplateRESTTestCase extends ESBIntegrationTest {
    ...
    public void testRESTURITemplate() throws Exception {
         ...
         */
        HttpResponse response = HttpRequestUtil.sendGetRequest(getApiInvocationURL("stockquote") + "/view/WSO2", null);
