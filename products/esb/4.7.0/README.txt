...
Welcome to the WSO2 ESB 4.7.0 release
...
8. WS-Security, WS-Reliable Messaging, Caching & Throttling configurable via
...
13. Database lookup & store support with DBMediators with reusable database
    connection pools
14. WS-Eventing support with event sources and event brokering
15. Rule based mediation of the messages using the Drools rule engine
16. Transactions support via the JMS transport and Transaction mediator for
    database mediators
17. Internationalized GUI management console with user/permission management for
    configuration development and monitoring support with statistics,
    configurable logging and tracing
18. JMX monitoring support and JMX management capabilities like,
...
1. Extract the wso2esb-4.7.0.zip and go to the extracted directory
...
WSO2 ESB 4.7.0 distribution directory structure
=============================================
	...
	- release-notes.html
	  Release information for WSO2 ESB 4.7.0
...
Known issues of WSO2 ESB 4.7.0
==================================
