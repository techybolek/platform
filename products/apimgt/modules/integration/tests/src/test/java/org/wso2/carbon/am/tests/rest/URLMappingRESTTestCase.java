...
public class URLMappingRESTTestCase extends APIManagerIntegrationTest {
    ...
    public void testRESTURITemplate() throws Exception {
        ...
        //HttpResponse response = HttpRequestUtil.sendGetRequest(getApiInvocationURL("stockquote") + "/test/", null);
        HttpResponse response = HttpRequestUtil.sendGetRequest("http://localhost:8280/stockquote" + "/test/", null);
