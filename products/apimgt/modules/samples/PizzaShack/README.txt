...
4) Run ‘mvn clean install’ at the directory '/pizza-shack-web' and '/pizza-shack-api'

5) Deploy pizza-shack-web/target/pizzashack.war  & pizza-shack-api/target/pizzashack-api-1.0.0.war into App Server
