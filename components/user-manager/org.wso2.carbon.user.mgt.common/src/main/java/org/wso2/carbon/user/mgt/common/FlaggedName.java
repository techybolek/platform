 ...
 * Carbon FE.
 * It contains information to indicate whether the representing item is editable
 ...
 * <p/>
 * Before FlaggedName
 * 1) Send the list of users that are already in the role so that I can show the
 * ticks in the GUI
