...
public class IdentityProviderMgtConstants {
    ...
    public static class SQLQueries {
        ...
        public static final String GET_TENANT_IDP_SQL = "SELECT UM_ID, UM_TENANT_IDP_URL, UM_TENANT_IDP_THUMBPRINT FROM UM_TENANT_IDP WHERE UM_TENANT_ID=? AND UM_TENANT_IDP_ISSUER=?";
