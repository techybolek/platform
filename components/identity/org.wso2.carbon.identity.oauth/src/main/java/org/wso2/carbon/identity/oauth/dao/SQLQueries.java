...
public class SQLQueries {
    ...
    public static class OAuthAppDAOSQLQueries {
        ...
        public static final String ADD_OAUTH_APP = "INSERT INTO IDN_OAUTH_CONSUMER_APPS " +
                "(CONSUMER_KEY, CONSUMER_SECRET, USERNAME, TENANT_ID, APP_NAME, OAUTH_VERSION, CALLBACK_URL, LOGIN_PAGE_URL, ERROR_PAGE_URL, CONSENT_PAGE_URL, GRANT_TYPES) VALUES (?,?,?,?,?,?,?,?,?,?,?) ";
        ...
        public static final String GET_APPS_OF_USER = "SELECT CONSUMER_KEY, CONSUMER_SECRET, APP_NAME, OAUTH_VERSION, CALLBACK_URL, LOGIN_PAGE_URL, ERROR_PAGE_URL, CONSENT_PAGE_URL, GRANT_TYPES FROM " +
                "IDN_OAUTH_CONSUMER_APPS WHERE USERNAME=? AND TENANT_ID=?";

        public static final String GET_APP_INFO = "SELECT CONSUMER_SECRET,USERNAME,APP_NAME, OAUTH_VERSION, CALLBACK_URL,TENANT_ID, LOGIN_PAGE_URL, ERROR_PAGE_URL, CONSENT_PAGE_URL, GRANT_TYPES FROM " +
        "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY=? ";

        public static final String UPDATE_CONSUMER_APP = "UPDATE IDN_OAUTH_CONSUMER_APPS SET CALLBACK_URL=?, LOGIN_PAGE_URL=?, ERROR_PAGE_URL=?, CONSENT_PAGE_URL=?, GRANT_TYPES=? " +
