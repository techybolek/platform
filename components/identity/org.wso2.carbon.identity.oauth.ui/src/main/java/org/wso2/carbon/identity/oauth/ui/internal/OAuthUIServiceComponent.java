 ...
 * @scr.reference name="oauth2.service" interface="org.wso2.carbon.identity.oauth2.OAuth2Service"
 * cardinality="1..1" policy="dynamic" bind="setOAuth2Service" unbind="unsetOAuth2Service"
 */
...
//        httpService.unregister(OAUTH2_AUTHORIZE_URL);
    ...
    protected void setOAuth2Service(OAuth2Service oauth2Service){
        OAuthUIServiceComponentHolder.getInstance().setOAuth2Service(oauth2Service);
        log.debug("OAuth2Service instance was set.");
    }

    protected void unsetOAuth2Service(OAuth2Service oauth2Service){
        OAuthUIServiceComponentHolder.getInstance().setOAuth2Service(null);
        log.debug("OAuth2Service instance was unset.");
    }
