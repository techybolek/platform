            ...
            <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <%
                                for (EntitlementFinderDataHolder entry :
                                        entitlementPolicyBean.getEntitlementFinders(category)) {
                ...
                %>
                    ...
                    <tr>
                        <td class="leftCel-med">
                            <fmt:message key="attribute.finder.module"/> <%=i%>
                        </td>
                        <td>
