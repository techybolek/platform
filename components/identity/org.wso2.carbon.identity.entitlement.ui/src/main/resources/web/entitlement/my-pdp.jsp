...
<script type="text/javascript">
    ...
    function enable(policy) {
        location.href = "enable-disable-policy.jsp?policyid=" + policy +"&action=enable&pdp=true";
    }

    function disable(policy) {
        location.href = "enable-disable-policy.jsp?policyid=" + policy +"&action=disable&pdp=true";
    }
...
<div id="middle">
    ...
    <form action="" name="policyForm" method="post">
        <table style="width: 100%" id="dataTable" class="styledLeft">
            <thead>
            <tr>
                <th colspan="5"><fmt:message key='my.pdp.policies'/></th>
            </tr>
            </thead>
            <tbody>
            <%
