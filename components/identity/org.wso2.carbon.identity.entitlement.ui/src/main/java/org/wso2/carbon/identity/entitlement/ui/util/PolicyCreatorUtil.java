...
//    }
    ...
    public static Element createBasicRuleElementDTO(BasicRuleElementDTO basicRuleElementDTO,
        ...
        String environmentDataType = basicRuleElementDTO.getEnvironmentDataType();
            ...
            if(userAttributeValue != null && userAttributeValue.trim().length() > 0){
                ...
                if(functionOnUserAttributes.equals(EntitlementPolicyConstants.EQUAL_TO) ||
                    ...
                    MatchElementDTO matchElementDTO = createMatchElementForNonBagFunctions(
                            ...
                            userAttributeValue, PolicyEditorConstants.SUBJECT_CATEGORY_URI, attributeId, subjectDataType);
                    Element matchElement= createMatchElement(matchElementDTO, doc);
                    if(matchElement != null){
    ...
    public static Element createBasicTargetElementDTO(BasicTargetElementDTO basicTargetElementDTO,
        ...
        String resourceDataType = basicTargetElementDTO.getResourceDataType();
        String subjectDataType = basicTargetElementDTO.getSubjectDataType();
        String actionDataType = basicTargetElementDTO.getActionDataType();
        String environmentDataType = basicTargetElementDTO.getResourceDataType();
...
//            applyElementDTO.setAddApplyElementPageNumber(addApplyElementNo);
    ...
    public static void processTargetPolicyEditorData(BasicTargetDTO targetDTO , String[] policyEditorData){
...
//     * @return  String Array to dent to back end
//     */
//    public static String[] createPolicyMetaData(BasicTargetDTO basicTargetDTO,
