...
public class SCMClient {
     ...
     *
     * @param baseURL                   repository url
     * @param version                   name of the branch
     * @param checkOutDirectoryToBranch Directory contains code to check in into new branch
     * @return
     * @throws RepositoryMgtException
     */
     ...
     *
     * @param baseURL                   Repository url
     * @param version                   Branch name
     * @param checkOutDirectoryToBranch Directory contains files to be compared against the source repository
     * @return
     * @throws RepositoryMgtException
     */
     ...
     * @param checkOutDirectory Directory to checkout
     ...
     *
     * @param url              Repository URL
     * @param checkInDirectory Directory contains file to checkin
     * @param msg              Message
     * @return
     * @throws RepositoryMgtException
     */
...
//        Adding the children recursively
     ...
     * @param checkOutDirectory Directory to checkout
     * @param revision          Revision to checkout
     * @param version           branch to checkout
     * @return
     * @throws RepositoryMgtException
     */
    public boolean checkOut(String url, File checkOutDirectory, String revision,
