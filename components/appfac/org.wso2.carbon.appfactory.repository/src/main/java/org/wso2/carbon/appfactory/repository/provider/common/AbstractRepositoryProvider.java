...
public abstract class AbstractRepositoryProvider implements RepositoryProvider {
    ...
    protected String getServerURL() {
        return config.getFirstProperty((AppFactoryConstants.SCM_SERVER_URL).replace("svn", getType()));
    }
...
//            Here we do the initialization as well
...
//            String userName = config.getFirstProperty(REPOSITORY_PROVIDER_CONFIG_PREFIX + getType() +
//                    SCM_ADMIN_USER_NAME_SUFFIX);
//            String password = config.getFirstProperty(REPOSITORY_PROVIDER_CONFIG_PREFIX + getType() +
//                    SCM_ADMIN_PASSWORD_SUFFIX);
