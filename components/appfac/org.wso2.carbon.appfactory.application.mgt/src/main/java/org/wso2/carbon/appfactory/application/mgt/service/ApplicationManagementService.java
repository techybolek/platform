...
public class ApplicationManagementService extends AbstractAdmin {
     ...
     *            user name
     * @param rolesToDelete
     *            roles to be removed from present roles of the user
     * @param rolesToAdd
     *            roles to be added to present roles of the user
	 ...
	 * @throws AppFactoryException
	 */
	public ApplicationInfoBean getBasicApplicationInfo(String applicationKey)
	                                                                         throws AppFactoryException {
		Application application = ProjectUtils.getApplicationInfo(applicationKey);
