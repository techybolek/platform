 ...
 */
public class TenantBuildManagerInitializerImpl implements TenantBuildManagerInitializer {
    private static final Log log = LogFactory.getLog(TenantBuildManagerInitializerImpl.class);
    ...
    public void onTenantCreation(String tenantDomain, String usagePlan) {
        log.info("**********************Initializing build manager for " + tenantDomain + " with " + usagePlan + " *************");
    }
}
