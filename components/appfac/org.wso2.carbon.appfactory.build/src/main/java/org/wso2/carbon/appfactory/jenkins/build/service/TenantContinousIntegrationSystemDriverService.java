...
public class TenantContinousIntegrationSystemDriverService extends AbstractAdmin {
     public void createJob(String applicationId, String version,
                          String revision, String tenantDomain) throws AppFactoryException {
        ServiceContainer.getJenkinsCISystemDriver().createJob(applicationId, version, revision, tenantDomain);
    }
}
