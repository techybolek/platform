...
//        } else {
//            sliceQuery.setKey(stringSerializer.toByteBuffer(rowName));
//        }
...
////            String columnKey = getStringDeserialization(hColumn.getNameBytes());
////            String columnValue = getStringDeserialization(hColumn.getValueBytes());
//
//                Column column = new Column(hColumn.getNameBytes(), hColumn.getValueBytes());
