            ...
            <table class="styledLeft" id="generalInfoTable"
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <input type="radio" name="processstate" value="retired"
                        ...
                        <input type="radio" name="processstate" value="disabled"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="radio" name="inmemorystatus" value="false"
...
<table class="styledLeft" style="margin-left: 2px;margin-top: 15px;margin-bottom: 15px;"
    ...
    <tr>
        <td>
            <input type="radio" name="gentype" value="none"
...
<table class="styledLeft" id="scopeEventsTable"
    ...
    <tr>
        ...
        <td>
            <input type="checkbox" name="scopeevents" value="activityLifecycle"
                    <%= BpelUIUtil.isGivenEventChecked(scopeLevelEnabledEvents, "activityLifecycle")%>>
            <input type="hidden" name="scopeevents" value="0"/>
        </td>
        <td>
            <input type="checkbox" name="scopeevents" value="dataHandling"
                    <%= BpelUIUtil.isGivenEventChecked(scopeLevelEnabledEvents, "dataHandling")%>>
            <input type="hidden" name="scopeevents" value="0"/>
        </td>
        <td>
            <input type="checkbox" name="scopeevents" value="scopeHandling"
                    <%= BpelUIUtil.isGivenEventChecked(scopeLevelEnabledEvents, "scopeHandling")%>>
            <input type="hidden" name="scopeevents" value="0"/>
        </td>
        <td>
            <input type="checkbox" name="scopeevents" value="correlation"
...
<table class="styledLeft" id="cleanUpsTable"
    ...
    <tr>
        ...
        <td>
            <input type="checkbox" id="successInstance" name="successtypecleanups" value="instance"
        ...
        <td>
            <input type="checkbox" id="successVariables" name="successtypecleanups"
                   value="variables"
        ...
        <td>
            <input type="checkbox" id="successMessages" name="successtypecleanups" value="messages"
                    <%= BpelUIUtil.isGivenEventChecked(successCategoryList, "messages")%>
                    <%= BpelUIUtil.isElementDisabled(isAuthorizedToManageProcesses)%>
                    <%= deployDescriptorUpdater.isSucMesCreated()%>>
        </td>
        <td>
            <input type="checkbox" id="successCorrelations" name="successtypecleanups"
                   value="correlations"
        ...
        <td>
            <input type="checkbox" id="successEvents" name="successtypecleanups" value="events"
    ...
    <tr>
        ...
        %>
        <td>
            <input type="checkbox" id="failureInstance" name="failuretypecleanups" value="instance"
        ...
        <td>
            <input type="checkbox" id="failureVariables" name="failuretypecleanups"
                   value="variables"
        ...
        <td>
            <input type="checkbox" id="failureMessages" name="failuretypecleanups" value="messages"
                    <%= BpelUIUtil.isGivenEventChecked(failureCategoryList, "messages")%>
                    <%= BpelUIUtil.isElementDisabled(isAuthorizedToManageProcesses)%>
                    <%= deployDescriptorUpdater.isFailMesCreated()%>>
        </td>
        <td>
            <input type="checkbox" id="failureCorrelations" name="failuretypecleanups"
                   value="correlations"
        ...
        <td>
            <input type="checkbox" id="failureEvents" name="failuretypecleanups" value="events"
