...
<% String eventFormatterName = request.getParameter("eventFormatterName");
    if (eventFormatterName != null) {
        EventFormatterConfigurationDto eventFormatterConfigurationDto = stub.getEventFormatterConfigurationDto(eventFormatterName);
%>
<tbody>
<tr>
<td class="formRaw">
...
<tr>
    <td class="leftCol-med"><fmt:message key="event.formatter.name"/><span class="required">*</span></td>
...
<div id="innerDiv2">
    <table class="styledLeft noBorders spacer-bot"
        ...
        <tr>
            <td class="leftCol-med" colspan="1"><fmt:message key="output.mapping.content"/><span class="required">*</span></td>
            <td colspan="2">
    ...
    height: 150px; margin-top: 5px;"
                              name="textSource"
                              rows="30" disabled="disabled"><%= eventFormatterConfigurationDto.getTextOutputMappingDto().getMappingText() %>
                    </textarea>
                </p>
            </td>
        </tr>
        <% } else { %>
        <tr>
            <td colspan="1" class="leftCol-med"><fmt:message key="output.mapping.content"/><span class="required">*</span></td>
            <td colspan="2">
        ...
        <tr name="outputTextMappingRegistry" id="outputTextMappingRegistry">
            <td class="leftCol-med" colspan="1"><fmt:message key="resource.path"/><span class="required">*</span></td>
            <td colspan="1">
                ...
                <p>
                    <textarea id="xmlSourceText"
                              style="border:solid 1px rgb(204, 204, 204); width: 99%;
                                     height: 150px; margin-top: 5px;"
                              name="xmlSource"
                              rows="30" disabled="disabled"><%=eventFormatterConfigurationDto.getXmlOutputMappingDto().getMappingXMLText()%>
                    </textarea>
                </p>
            </td>
        </tr>
                ...
                <p>
                    <textarea id="jsonSourceText"
                              style="border:solid 1px rgb(204, 204, 204); width: 99%;
                                     height: 150px; margin-top: 5px;"
                              name="jsonSource"
                              rows="30" disabled="disabled"><%=eventFormatterConfigurationDto.getJsonOutputMappingDto().getMappingText()%>
                    </textarea>
                </p>
            </td>
        </tr>
