...
<%
    ...
    if (eventFormatterName != null) {
        stub.removeEventFormatterConfiguration(eventFormatterName);
%>
<script type="text/javascript">CARBON.showInfoDialog('Event Formatter successfully deleted.');</script>
<%
    }

    EventFormatterConfigurationInfoDto[] eventFormatterDetailsArray = stub.getAllEventFormatterConfigurationInfo();
    if (eventFormatterDetailsArray != null) {
        totalEventFormatters = eventFormatterDetailsArray.length;
    }

    EventFormatterConfigurationFileDto[] notDeployedEventFormatterConfigurationFiles = stub.getNotDeployedEventFormatterConfigurationFiles();
...
<div id="middle">
    <div id="workArea">
        <h3><fmt:message key="available.event.formatters"/></h3><br/>
        <h5 class="activeEventFormatters"><%=totalEventFormatters%> <fmt:message
        ...
        <table class="styledLeft">
            ...
            <tr>
                ...
                <td><%=eventFormatterDetails.getOutputTransportAdaptorType()%>
                </td>
                <td>
            ...
            <thead>
            <tr>
                <th><fmt:message key="empty.event.formatter.header"/></th>
            </tr>
            </thead>
            <tbody>
            <tr>
