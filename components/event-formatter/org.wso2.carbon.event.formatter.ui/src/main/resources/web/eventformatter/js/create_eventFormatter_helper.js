...
function loadTransportAdaptorMessageProperties(messageProperty, eventFormatterInputTable,
    ...
    if (messageProperty.localOptions == '') {
        ...
        if (hint != undefined) {
            inputField.innerHTML = '<div class="' + classType + '"> <input style="width:50%" type="' + textPasswordType + '" id="' + requiredElementId + propertyLoop + '" name="' + messageProperty.localKey + '" value="' + defaultValue + '" class="initE"  /> <br/> <div class="sectionHelp">' + hint + '</div></div>';
        }
        else {
            inputField.innerHTML = '<div class="' + classType + '"> <input style="width:50%" type="' + textPasswordType + '" id="' + requiredElementId + propertyLoop + '" name="' + messageProperty.localKey + '" value="' + defaultValue + '" class="initE"  /> </div>';
        }
    }
...
function showEventStreamDefinition() {
    ...
    jQuery.ajax({
                    type:"POST",
                    url:"../eventformatter/get_streamdefinition_ajaxprocessor.jsp?streamName=" + selected_text + "",
                    data:{},
