...
public class EventFormatterConfiguration {
    ...
    private EventFormatterFactory eventFormatterFactory;

    private boolean enableTracing;

    private boolean enableStatistics;

    public EventFormatterConfiguration(EventFormatterFactory eventFormatterFactory) {
    ...
    public EventFormatterFactory getEventFormatterFactory() {
        return eventFormatterFactory;
    }

    public void setEventFormatterFactory(EventFormatterFactory eventFormatterFactory) {
        this.eventFormatterFactory = eventFormatterFactory;
    }
