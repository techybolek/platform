...
public class MapEventFormatterFactory implements EventFormatterFactory {


    @Override
    public OutputMapping constructOutputMapping(OMElement omElement) {
        return MapFormatterConfigurationBuilder.fromOM(omElement);
    }

    @Override
    public OMElement constructOutputMappingOM(OutputMapping outputMapping, OMFactory factory) {
        return MapFormatterConfigurationBuilder.outputMappingToOM(outputMapping, factory);
    }

    @Override
    public EventFormatter constructEventFormatter(
            EventFormatterConfiguration eventFormatterConfiguration, int tenantId) {
        return new MapOutputEventFormatter(eventFormatterConfiguration, tenantId);
    }
}
