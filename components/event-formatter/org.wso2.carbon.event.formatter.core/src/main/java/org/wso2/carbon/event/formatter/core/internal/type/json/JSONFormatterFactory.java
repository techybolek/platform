...
public class JSONFormatterFactory implements EventFormatterFactory {


    @Override
    public OutputMapping constructOutputMapping(OMElement omElement) {
        return JSONFormatterConfigurationBuilder.fromOM(omElement);
    }

    @Override
    public OMElement constructOutputMappingOM(OutputMapping outputMapping, OMFactory factory) {
        return JSONFormatterConfigurationBuilder.outputMappingToOM(outputMapping, factory);
    }

    @Override
    public EventFormatter constructEventFormatter(
            EventFormatterConfiguration eventFormatterConfiguration, int tenantId) {
        return new JSONOutputEventFormatter(eventFormatterConfiguration, tenantId);
    }
}
