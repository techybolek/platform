...
public class EventFormatterConfigurationException extends RuntimeException {
    ...
    public EventFormatterConfigurationException(String message) {
        super(message);
    }

    public EventFormatterConfigurationException(String message, Throwable cause) {
        super(message, cause);
    }

    public EventFormatterConfigurationException(Throwable cause) {
        super(cause);
    }
}
