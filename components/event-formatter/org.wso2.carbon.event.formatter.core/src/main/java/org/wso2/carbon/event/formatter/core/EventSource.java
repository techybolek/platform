...
public interface EventSource {
    ...
    public abstract StreamDefinition getStreamDefinition(String StreamName, String StreamVersion,
                                                         int tenantId);

    public abstract void subscribe(int tenantId, StreamDefinition streamDefinition,
                                   EventFormatterListener eventListener)
