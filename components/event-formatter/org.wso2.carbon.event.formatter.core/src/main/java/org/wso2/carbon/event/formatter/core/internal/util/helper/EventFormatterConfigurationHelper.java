...
public class EventFormatterConfigurationHelper {
    ...
    private static final Log log = LogFactory.getLog(EventFormatterConfigurationHelper.class);
    ...
    public static void validateEventFormatterConfiguration(OMElement eventFormatterOMElement) throws
        ...
        Iterator<OMElement> childElements = eventFormatterOMElement.getChildElements();
        int count = 0;
    ...
    private static boolean validateToPropertyConfiguration(OMElement toElement,
        ...
        if (messagePropertyList != null) {
            ...
            Iterator<Property> messagePropertyIterator = messagePropertyList.iterator();
            while (messagePropertyIterator.hasNext()) {
                Property property = messagePropertyIterator.next();
