...
public class EventFormatterConfigurationFilesystemInvoker {
    ...
    public static void saveConfigurationToFileSystem(OMElement eventFormatterOMElement,
                                                     String eventFormatterName,
                                                     String pathInFileSystem,
                                                     AxisConfiguration axisConfiguration)
            throws EventFormatterConfigurationException {

        EventFormatterConfigurationFilesystemInvoker.save(eventFormatterOMElement.toString(), eventFormatterName, pathInFileSystem, axisConfiguration);
    }

    public static void save(String eventFormatter, String eventFormatterName,
        ...
        try {
            ...
            out.close();
            log.info("Event formatter configuration for " + eventFormatterName + " saved in the filesystem");
            ...
            reload(filePath,axisConfiguration);

        } catch (IOException e) {
            log.error("Error while saving " + eventFormatterName, e);
    ...
    public static void delete(String filePath,
        ...
        try {
            ...
            throw new EventFormatterConfigurationException("Error while deleting the event formatter ", e);
        }
    }
    ...
    public static void reload(String filePath, AxisConfiguration axisConfiguration){
        ...
        try {
            deployer.processDeploy(deploymentFileData, filePath);
