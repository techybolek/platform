...
public class EventFormatterConfigurationInfoDto {
    ...
    private String outputTransportAdaptorType;
    ...
    public String getOutputTransportAdaptorType() {
        return outputTransportAdaptorType;
    }

    public void setOutputTransportAdaptorType(String outputTransportAdaptorType) {
        this.outputTransportAdaptorType = outputTransportAdaptorType;
    }
