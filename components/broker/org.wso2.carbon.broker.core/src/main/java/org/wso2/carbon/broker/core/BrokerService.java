...
public interface BrokerService {
     ...
     */
    List<BrokerTypeDto> getBrokerTypes();
     ...
     */
    List<String> getBrokerTypeNames();
     ...
     */
    List<Property> getBrokerProperties(String brokerType);
     ...
     */
    void publish(BrokerConfiguration brokerConfiguration,
                 String topicName,
