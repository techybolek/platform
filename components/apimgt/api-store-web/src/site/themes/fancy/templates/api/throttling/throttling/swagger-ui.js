...
(function() {
  var ContentTypeView, HeaderView, MainView, OperationView, ParameterView, ResourceView, SignatureView, StatusCodeView, throttlingUi,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  throttlingUi = (function(_super) {

    __extends(throttlingUi, _super);

    function throttlingUi() {
      return throttlingUi.__super__.constructor.apply(this, arguments);
    }

    throttlingUi.prototype.dom_id = "throttling_ui";

    throttlingUi.prototype.options = null;

    throttlingUi.prototype.api = null;

    throttlingUi.prototype.headerView = null;

    throttlingUi.prototype.mainView = null;

    throttlingUi.prototype.initialize = function(options) {
      var _this = this;
      if (options == null) {
        options = {};
      }
      ...
      return this.headerView.on('update-throttling-ui', function(data) {
        return _this.updatethrottlingUi(data);
      });
    };

    throttlingUi.prototype.updatethrottlingUi = function(data) {
      this.options.discoveryUrl = data.discoveryUrl;
      this.options.apiKey = data.apiKey;
      return this.load();
    };

    throttlingUi.prototype.load = function() {
      var _ref;
      if ((_ref = this.mainView) != null) {
        _ref.clear();
      }
      this.headerView.update(this.options.discoveryUrl, this.options.apiKey);
      return this.api = new throttlingApi(this.options);
    };

    throttlingUi.prototype.render = function() {
      var _this = this;
      this.showMessage('Finished Loading Resource Information. Rendering throttling UI...');
    ...
    throttlingUi.prototype.showMessage = function(data) {
      if (data == null) {
        data = '';
      }
    ...
    throttlingUi.prototype.onLoadFailure = function(data) {
      var val;
      if (data == null) {
        data = '';
      }
  ...
  window.throttlingUi = throttlingUi;
  ...
  HeaderView = (function(_super) {
    ...
    HeaderView.prototype.showPetStore = function(e) {
      return this.trigger('update-throttling-ui', {
        discoveryUrl: "http://petstore.throttling.wordnik.com/api/api-docs.json",
        apiKey: "special-key"
      });
    };
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.toggleOperationContent = function() {
      var elem;
      elem = $('[id="'+this.model.resourceName + '_' + this.model.nickname + '_' + this.model.httpMethod + '_' + this.model.number + '_content' + '"]');
      if (elem.is(':visible')) {
