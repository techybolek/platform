...
(function() {
  var throttlingApi, throttlingModel, throttlingModelProperty, throttlingOperation, throttlingRequest, throttlingResource,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

  throttlingApi = (function() {

    throttlingApi.prototype.discoveryUrl = "http://api.wordnik.com/v4/resources.json";

    throttlingApi.prototype.debug = false;

    throttlingApi.prototype.api_key = null;

    throttlingApi.prototype.basePath = null;

    function throttlingApi(options) {
      if (options == null) {
        options = {};
      }
    ...
    throttlingApi.prototype.build = function() {
      var _this = this;
      ...
      return jQuery.getJSON(this.discoveryUrl, function(response) {
        ...
        if (response.resourcePath != null) {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            resource = _ref[_i];
            if (res === null) {
              res = new throttlingResource(resource, _this);
            } else {
    ...
    throttlingApi.prototype.selfReflect = function() {
    ...
    throttlingApi.prototype.fail = function(message) {
      this.failure(message);
      throw message;
    };

    throttlingApi.prototype.setConsolidatedModels = function() {
    ...
    throttlingApi.prototype.suffixApiKey = function(url) {
      var sep;
    ...
    throttlingApi.prototype.help = function() {
    ...
    return throttlingApi;

  })();

  throttlingResource = (function() {

    function throttlingResource(resourceObj, api) {
      var parts,
        _this = this;
      this.api = api;
      ...
      if ((resourceObj.operations != null) && (this.api.resourcePath != null)) {
        ...
        if (this.path == null) {
          this.api.fail("throttlingResources must have a path.");
        }
    ...
    throttlingResource.prototype.addModels = function(models) {
      var model, modelName, throttlingModel, _i, _len, _ref, _results;
      if (models != null) {
        for (modelName in models) {
          throttlingModel = new throttlingModel(modelName, models[modelName]);
          this.modelsArray.push(throttlingModel);
          this.models[modelName] = throttlingModel;
        }
    ...
    throttlingResource.prototype.addOperations = function(resource_path, ops) {
      var o, op, _i, _len, _results;
      if (ops) {
        _results = [];
        for (_i = 0, _len = ops.length; _i < _len; _i++) {
          o = ops[_i];
          op = new throttlingOperation(o.nickname, resource_path, o.httpMethod, o.parameters, o.summary, o.notes, o.responseClass, o.errorResponses, this, o.supportedContentTypes);
    ...
    throttlingResource.prototype.help = function() {
    ...
    return throttlingResource;

  })();

  throttlingModel = (function() {

    function throttlingModel(modelName, obj) {
      var propertyName;
      this.name = obj.id != null ? obj.id : modelName;
      this.properties = [];
      for (propertyName in obj.properties) {
        this.properties.push(new throttlingModelProperty(propertyName, obj.properties[propertyName]));
      }
    }

    throttlingModel.prototype.setReferencedModels = function(allModels) {
    ...
    throttlingModel.prototype.getMockSignature = function(prefix, modelToIgnore) {
    ...
    throttlingModel.prototype.createJSONSample = function(modelToIgnore) {
    ...
    return throttlingModel;

  })();

  throttlingModelProperty = (function() {

    function throttlingModelProperty(name, obj) {
      this.name = name;
    ...
    throttlingModelProperty.prototype.getSampleValue = function(modelToIgnore) {
      var result;
    ...
    throttlingModelProperty.prototype.toString = function() {
      var str;
    ...
    return throttlingModelProperty;

  })();

  throttlingOperation = (function() {

    function throttlingOperation(nickname, path, httpMethod, parameters, summary, notes, responseClass, errorResponses, resource, supportedContentTypes) {
      ...
      if (this.nickname == null) {
        this.resource.api.fail("throttlingOperations must have a nickname.");
      }
      if (this.path == null) {
        this.resource.api.fail("throttlingOperation " + nickname + " is missing path.");
      }
      if (this.httpMethod == null) {
        this.resource.api.fail("throttlingOperation " + nickname + " is missing httpMethod.");
      }
    ...
    throttlingOperation.prototype.isListType = function(dataType) {
    ...
    throttlingOperation.prototype.getSignature = function(dataType, models) {
    ...
    throttlingOperation.prototype.getSampleJSON = function(dataType, models) {
    ...
    throttlingOperation.prototype["do"] = function(args, callback, error) {
      var body, headers;
      if (args == null) {
        args = {};
      }
      ...
      return new throttlingRequest(this.httpMethod, this.urlify(args), headers, body, callback, error, this);
    };

    throttlingOperation.prototype.pathJson = function() {
      return this.path.replace("{format}", "json");
    };

    throttlingOperation.prototype.pathXml = function() {
      return this.path.replace("{format}", "xml");
    };

    throttlingOperation.prototype.urlify = function(args, includeApiKey) {
    ...
    throttlingOperation.prototype.supportHeaderParams = function() {
      return this.resource.api.supportHeaderParams;
    };

    throttlingOperation.prototype.supportedSubmitMethods = function() {
      return this.resource.api.supportedSubmitMethods;
    };

    throttlingOperation.prototype.getQueryAndHeaderParams = function(args, includeApiKey) {
      if (includeApiKey == null) {
        includeApiKey = true;
      }
    ...
    throttlingOperation.prototype.getQueryParams = function(args, includeApiKey) {
      if (includeApiKey == null) {
        includeApiKey = true;
      }
    ...
    throttlingOperation.prototype.getHeaderParams = function(args, includeApiKey) {
      if (includeApiKey == null) {
        includeApiKey = true;
      }
    ...
    throttlingOperation.prototype.getMatchingParams = function(paramTypes, args, includeApiKey) {
    ...
    throttlingOperation.prototype.help = function() {
    ...
    return throttlingOperation;

  })();

  throttlingRequest = (function() {

    function throttlingRequest(type, url, headers, body, successCallback, errorCallback, operation) {
      var obj,
        _this = this;
      this.type = type;
      this.url = url;
      ...
      if (this.type == null) {
        throw "throttlingRequest type is required (get/post/put/delete).";
      }
      if (this.url == null) {
        throw "throttlingRequest url is required.";
      }
      if (this.successCallback == null) {
        throw "throttlingRequest successCallback is required.";
      }
      if (this.errorCallback == null) {
        throw "throttlingRequest error callback is required.";
      }
      if (this.operation == null) {
        throw "throttlingRequest operation is required.";
      }
    ...
    throttlingRequest.prototype.asCurl = function() {
      var header_args, k, v;
    ...
    return throttlingRequest;

  })();

  window.throttlingApi = throttlingApi;

  window.throttlingResource = throttlingResource;

  window.throttlingOperation = throttlingOperation;

  window.throttlingRequest = throttlingRequest;
