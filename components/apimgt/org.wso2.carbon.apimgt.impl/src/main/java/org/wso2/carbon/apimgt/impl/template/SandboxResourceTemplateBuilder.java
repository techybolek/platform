...
public class SandboxResourceTemplateBuilder implements ResourceTemplateBuilder{
    ...
    public String getResourceString(Map<String, String> resourceAttributeMap,
        ...
        if(ApiMgtDAO.jwtGenerator != null){
            resourceTemplate =
                    templateLoader.getTemplate(TemplateLoader.TEMPLATE_TYPE_SANDBOX_ONLY_RESOURCE_WITH_JWT);
        }else{
            resourceTemplate =
                    templateLoader.getTemplate(TemplateLoader.TEMPLATE_TYPE_SANDBOX_ONLY_RESOURCE);
        }
