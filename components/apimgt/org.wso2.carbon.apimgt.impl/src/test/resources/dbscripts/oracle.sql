...
CREATE SEQUENCE AM_RATING_SEQUENCE START WITH 1 INCREMENT BY 1
/

CREATE OR REPLACE TRIGGER AM_RATING_TRIGGER
		            BEFORE INSERT
                    ON AM_RATING
                    REFERENCING NEW AS NEW
                    FOR EACH ROW
                    BEGIN
                    SELECT AM_RATING_SEQUENCE.nextval INTO :NEW.RATING_ID FROM dual;
                    END;
/
