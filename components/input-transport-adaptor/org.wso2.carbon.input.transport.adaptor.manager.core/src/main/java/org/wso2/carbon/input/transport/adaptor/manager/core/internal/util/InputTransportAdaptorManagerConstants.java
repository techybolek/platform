...
package org.wso2.carbon.input.transport.adaptor.manager.core.internal.util;

public final class InputTransportAdaptorManagerConstants {

    private InputTransportAdaptorManagerConstants() {
    }

    public static final String TM_CONF_NS = "http://wso2.org/carbon/transportadaptormanager";
    public static final String TM_ELE_ROOT_ELEMENT = "inputtransportAdaptor";
    public static final String TM_ELE_DIRECTORY = "inputtransportadaptors";
