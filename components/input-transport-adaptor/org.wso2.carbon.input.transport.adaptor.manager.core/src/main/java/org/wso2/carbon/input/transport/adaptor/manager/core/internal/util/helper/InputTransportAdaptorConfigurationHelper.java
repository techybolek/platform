...
public class InputTransportAdaptorConfigurationHelper {
    ...
    public static InputTransportAdaptorConfiguration fromOM(OMElement transportConfigOMElement) {
        ...
        if (transportConfigOMElement.getAttributeValue(new QName(InputTransportAdaptorManagerConstants.TM_ATTR_STATISTICS)) != null && transportConfigOMElement.getAttributeValue(new QName(InputTransportAdaptorManagerConstants.TM_ATTR_STATISTICS)).equals("true")) {
            transportAdaptorConfiguration.setEnableStatistics(true);
        }

        if (transportConfigOMElement.getAttributeValue(new QName(InputTransportAdaptorManagerConstants.TM_ATTR_TRACING)) != null && transportConfigOMElement.getAttributeValue(new QName(InputTransportAdaptorManagerConstants.TM_ATTR_TRACING)).equals("true")) {
    ...
    public static OMElement transportAdaptorConfigurationToOM(
        ...
        if (transportAdaptorConfiguration.isEnableStatistics()) {
            transportAdaptorItem.addAttribute(InputTransportAdaptorManagerConstants.TM_ATTR_STATISTICS, "true",
                                              null);
        }

        if (transportAdaptorConfiguration.isEnableTracing()) {
            transportAdaptorItem.addAttribute(InputTransportAdaptorManagerConstants.TM_ATTR_TRACING, "true",
                                              null);
        }
        ...
        if (inputTransportAdaptorProperties != null && (inputAdaptorConfigurationPropertyList != null)) {
            ...
            while (propertyConfigurationIterator.hasNext()) {
                ...
                if (!inputPropertyNames.contains(transportPropertyName)) {
                    ...
                    throw new InputTransportAdaptorManagerConfigurationException(transportPropertyName + " is not a valid property for this transport adaptor type : " + transportAdaptorConfiguration.getType());
                }
