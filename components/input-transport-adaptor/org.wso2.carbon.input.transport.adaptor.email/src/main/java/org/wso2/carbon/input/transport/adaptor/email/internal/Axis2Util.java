...
public class Axis2Util {
    ...
    public static AxisService registerAxis2EmailService(InputTransportAdaptorMessageConfiguration inputTransportAdaptorMessageConfiguration, InputTransportAdaptorListener transportAdaptorListener, InputTransportAdaptorConfiguration inputTransportAdaptorConfiguration,
...
//            <parameter name="transport.mail.ContentType">application/xml</parameter>
        ...
        String operationName = inputTransportAdaptorMessageConfiguration.getInputMessageProperties().get(EmailTransportAdaptorConstants.TRANSPORT_MESSAGE_RECEIVING_EMAIL_SUBJECT);
...
//        AxisEvent serviceUpdateEvent = new AxisEvent(AxisEvent.SERVICE_DEPLOY,axisService);
     ...
     * @throws AxisFault
     */
    public static void removeEmailServiceOperation(InputTransportAdaptorMessageConfiguration inputTransportAdaptorMessageConfiguration,
