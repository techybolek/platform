...
import org.wso2.carbon.input.transport.adaptor.wsevent.WSEventTransportAdaptorType;

public class WSEventTransportAdaptorFactory implements InputTransportAdaptorFactory {

    public AbstractInputTransportAdaptor getTransportAdaptor() {
        return WSEventTransportAdaptorType.getInstance();
    }
}
