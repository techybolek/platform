...
<%
    ...
    if (transportName != null) {
        ...
        stub.removeInputTransportAdaptorConfiguration(transportName);
%>
...
<%
    ...
    InputTransportAdaptorManagerAdminServiceStub stub = InputTransportAdaptorUIUtils.getInputTransportManagerAdminService(config, session, request);
    InputTransportAdaptorConfigurationInfoDto[] transportDetailsArray = stub.getAllInputTransportAdaptorConfigurationInfo();
    if (transportDetailsArray != null) {
        totalTransportAdaptors = transportDetailsArray.length;
    }

    InputTransportAdaptorFileDto[] notDeployedTransportAdaptorConfigurationFiles = stub.getNotDeployedInputTransportAdaptorConfigurationFiles();
...
<div id="middle">
<div id="workArea">
    <h3><fmt:message key="available.input.transport.adaptors"/></h3><br/>
