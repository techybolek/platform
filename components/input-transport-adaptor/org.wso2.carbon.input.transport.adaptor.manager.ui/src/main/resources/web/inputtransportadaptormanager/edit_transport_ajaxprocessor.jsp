...
<%
    ...
    if (transportName != null) {
        try {
            ...
            stub.editInputTransportAdaptorConfigurationFile(transportAdaptorConfiguration, transportName);
            msg = "true";
        } catch (Exception e) {
            msg = e.getMessage();
        ...
        try {
            // add transport adaptor via admin service
            stub.editNotDeployedInputTransportAdaptorConfigurationFile(transportAdaptorConfiguration, transportPath);
            msg = "true";
        } catch (Exception e) {
            msg = e.getMessage();
