...
package org.wso2.carbon.input.transport.adaptor.wsevent.local.internal.util;
...
public final class Axis2Util {
    ...
    public static AxisService registerAxis2Service(
        ...
        String topicNameWithoutSlash = inputTransportMessageConfiguration.getInputMessageProperties().get(WSEventLocalTransportAdaptorConstants.TRANSPORT_MESSAGE_TOPIC_NAME).replaceAll("/", "");
    ...
    public static void removeOperation(
        ...
        if (messageReceiver.removeTransportAdaptorListener(subscriptionId)) {
            axisService.removeOperation(new QName("", inputTransportMessageConfiguration.getInputMessageProperties().get(WSEventLocalTransportAdaptorConstants.TRANSPORT_MESSAGE_TOPIC_NAME).replaceAll("/", "")));
        }
