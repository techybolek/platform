...
public class JMSMessageListener implements MessageListener {
    ...
    private InputTransportAdaptorListener transportAdaptorListener = null;

    public JMSMessageListener(InputTransportAdaptorListener transportAdaptorListener) {
    ...
    public void onMessage(Message message) {
        if (message instanceof TextMessage) {
            ...
            try {
                ...
                transportAdaptorListener.onEventCall(omMessage);
