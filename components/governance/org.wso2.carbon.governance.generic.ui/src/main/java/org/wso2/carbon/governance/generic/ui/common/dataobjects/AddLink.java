...
public class AddLink extends UIComponent {
	...
	public AddLink(String label, String name, String addIconPath, String widget, String[] subList, boolean isPath, String startsWith,boolean isDisplay) {
	    super(label, name, null, widget, false, null);
