...
public class MediationUtils {
    ...
    private static GenericArtifact getArtifactFromRegistry(String name, String key) throws RegistryException {
        GenericArtifactManager artifactManager = new GenericArtifactManager(getGovernanceRegistry(), key);
        Map<String, List<String>> map = new HashMap<String, List<String>>();
        List<String> names = new ArrayList<String>();
        names.add(name);
        map.put(MediationArtifactConstants.NAME_FIELD, names);
    ...
    private static GenericArtifact getArtifactFromRegistry(String name, GenericArtifactManager artifactManager) throws RegistryException {
        Map<String, List<String>> map = new HashMap<String, List<String>>();
        List<String> names = new ArrayList<String>();
        List<String> version = new ArrayList<String>();
        names.add(name);
        version.add(MediationArtifactConstants.ARTIFACT_COMMON_VERSION);
        map.put(MediationArtifactConstants.NAME_FIELD, names);
        map.put(MediationArtifactConstants.VERSION_FIELD,version);
        GenericArtifact[] artifacts = artifactManager.findGenericArtifacts(map);
        if (artifacts.length != 0) {
            return artifacts[0];
        }
