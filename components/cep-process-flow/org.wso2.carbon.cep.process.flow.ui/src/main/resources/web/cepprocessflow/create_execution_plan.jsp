...
<fmt:bundle basename="org.wso2.carbon.cep.process.flow.ui.i18n.Resources">
    ...
    <div id="middle">
        <div id="workArea">
            ...
            <tbody>
            <tr>
                <td><h4><fmt:message key="title.execution.plan.create"/></h4></td>
                <td style="text-align:right;">
                    <input type="button" value="Create Event Builder"
                            ...
                            <table id="noExecutionPlanInputTable" class="normal-nopadding"
                                ...
                                <tr>
                                    <td class="leftCol-med" colspan="2">Event Streams are not
                                                                        available to import. Please Create Event Builders to proceed further
                                    </td>
                                </tr>
                                </tbody>
                            </table>
