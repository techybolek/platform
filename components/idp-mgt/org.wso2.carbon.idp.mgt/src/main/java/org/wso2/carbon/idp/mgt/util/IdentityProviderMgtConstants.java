...
public class IdentityProviderMgtConstants {
    ...
    public static class SQLQueries {
        ...
        public static final String GET_TENANT_IDP_SQL = "SELECT UM_ID, UM_TENANT_IDP_URL, UM_TENANT_IDP_THUMBPRINT, UM_TENANT_IDP_PRIMARY, UM_TENANT_IDP_AUDIENCE FROM UM_TENANT_IDP WHERE UM_TENANT_ID=? AND UM_TENANT_IDP_ISSUER=?";
        ...
        public static final String UPDATE_TENANT_IDP_SQL = "UPDATE UM_TENANT_IDP SET UM_TENANT_IDP_ISSUER=?, UM_TENANT_IDP_URL=?, UM_TENANT_IDP_THUMBPRINT=?, UM_TENANT_IDP_PRIMARY=?, UM_TENANT_IDP_AUDIENCE=? WHERE UM_TENANT_ID=? AND UM_TENANT_IDP_ISSUER=?";
        ...
        public static final String ADD_TENANT_IDP_SQL = "INSERT INTO UM_TENANT_IDP (UM_TENANT_ID, UM_TENANT_IDP_ISSUER, UM_TENANT_IDP_URL, UM_TENANT_IDP_THUMBPRINT, UM_TENANT_IDP_PRIMARY, UM_TENANT_IDP_AUDIENCE) VALUES (?, ?, ?, ?, ?, ?)";
