...
public class IdentityProviderMgtConstants {
    ...
    public static class SQLQueries {
        ...
        public static final String GET_TENANT_IDP_SQL = "SELECT UM_ID, UM_TENANT_IDP_ISSUER, UM_TENANT_IDP_URL, UM_TENANT_IDP_THUMBPRINT, UM_TENANT_IDP_PRIMARY, UM_TENANT_IDP_AUDIENCE FROM UM_TENANT_IDP WHERE UM_TENANT_ID=? AND UM_TENANT_IDP_NAME=?";
        ...
        public static final String UPDATE_TENANT_IDP_SQL = "UPDATE UM_TENANT_IDP SET UM_TENANT_IDP_NAME=?, UM_TENANT_IDP_ISSUER=?, UM_TENANT_IDP_URL=?, UM_TENANT_IDP_THUMBPRINT=?, UM_TENANT_IDP_PRIMARY=?, UM_TENANT_IDP_AUDIENCE=? WHERE UM_TENANT_ID=? AND UM_TENANT_IDP_NAME=?";
        ...
        public static final String ADD_TENANT_IDP_SQL = "INSERT INTO UM_TENANT_IDP (UM_TENANT_ID, UM_TENANT_IDP_NAME, UM_TENANT_IDP_ISSUER, UM_TENANT_IDP_URL, UM_TENANT_IDP_THUMBPRINT, UM_TENANT_IDP_PRIMARY, UM_TENANT_IDP_AUDIENCE) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        public static final String DELETE_TENANT_ROLE_SQL = "DELETE FROM UM_TENANT_IDP_ROLES WHERE (UM_TENANT_ID=? AND UM_TENANT_ROLE=?)";
        public static final String RENAME_TENANT_ROLE_SQL = "UPDATE UM_TENANT_IDP_ROLES SET UM_TENANT_ROLE=? WHERE (UM_TENANT_ID=? AND UM_TENANT_ROLE=?)";
