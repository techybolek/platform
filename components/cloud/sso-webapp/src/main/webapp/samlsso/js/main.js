...
$(document).ready(function(){
  ...
  // Click on Popover
	$('.content').on('click', '.js_create_branch', function(event){  
    var _this = $(this)
    ...
    // Out side click
    _this.next().outsideClick({ outerEvent: event, clickHandler: _this })

		 event.preventDefault()
	}); 

  // Click on option button
  $('.content').on('click', '.js_build_option', function(event){
    var _this = $(this)
  ...
  /* 
	$('.js_create_branch').live("click", function(event){  
...
$('.popover_close').live('click', function() {
	...
	$('.js_accordion').live("click", function(event){ 
		...
		if( collapse_indicator.hasClass("icon-chevron-down")){  
		    collapse_indicator.removeClass("icon-chevron-down") 
	...
	$('.in .collapse_indicator').live("click", function(event){ 
		if( $(this).closest('.row').hasClass("in")){  
		    ...
		    $(this).removeClass("icon-chevron-down").addClass("icon-chevron-up").on('click');
