...
public class JSONOutputMapperFactory implements OutputMapperFactory {
    ...
    public OutputMapper constructOutputMapper(
        ...
        return new JSONOutputMapper(eventFormatterConfiguration, propertyPositionMap, tenantId);
    }
}
