...
public class TransportAdaptorNotificationListenerImpl
    ...
    public void configurationAdded(int tenantId, String transportAdaptorName) {
        ...
        try {
            carbonEventFormatterService.activateInactiveEventFormatterConfiguration(tenantId, transportAdaptorName);
    ...
    public void configurationRemoved(int tenantId, String transportAdaptorName) {
        ...
        try {
            carbonEventFormatterService.deactivateActiveEventFormatterConfiguration(tenantId, transportAdaptorName);
        } catch (EventFormatterConfigurationException e) {
            log.error("Exception occurred while deploying the Event formatter configuration files");
        }
    }
