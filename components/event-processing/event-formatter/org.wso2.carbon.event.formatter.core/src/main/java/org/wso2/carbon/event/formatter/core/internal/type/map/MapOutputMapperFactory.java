...
public class MapOutputMapperFactory implements OutputMapperFactory {
    ...
    public OutputMapper constructOutputMapper(
        ...
        return new MapOutputOutputMapper(eventFormatterConfiguration, propertyPositionMap, tenantId);
    }
}
