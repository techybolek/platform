...
<%
    ...
    if (mappingType.equals("wso2event")) {
        ...
        try {
            ...
            stub.deployWSO2EventFormatterConfiguration(eventFormatterName, streamNameWithVersion, transportAdaptorName, metaWSO2EventConfiguration, correlationWSO2EventConfiguration, payloadWSO2EventConfiguration, eventFormatterProperties);
            msg = "true";
        } catch (Exception e) {
            msg = e.getMessage();
...
<%
    ...
    try {
        // add transport adaptor via admin service
        stub.deployTextEventFormatterConfiguration(eventFormatterName, streamNameWithVersion, transportAdaptorName, dataSet, eventFormatterProperties, dataFrom);
        msg = "true";
    } catch (Exception e) {
        msg = e.getMessage();
...
<%
    ...
    try {
        // add transport adaptor via admin service
        stub.deployXmlEventFormatterConfiguration(eventFormatterName, streamNameWithVersion, transportAdaptorName, dataSet, eventFormatterProperties, dataFrom);
        msg = "true";
    } catch (Exception e) {
        msg = e.getMessage();
...
<%
    ...
    try {
        // add transport adaptor via admin service
        stub.deployMapEventFormatterConfiguration(eventFormatterName, streamNameWithVersion, transportAdaptorName, eventOutputPropertyConfiguration, eventFormatterProperties);
        msg = "true";
    } catch (Exception e) {
        msg = e.getMessage();
...
<%
    ...
    try {
        // add transport adaptor via admin service
        stub.deployJsonEventFormatterConfiguration(eventFormatterName, streamNameWithVersion, transportAdaptorName, dataSet, eventFormatterProperties, dataFrom);
        msg = "true";
    } catch (Exception e) {
        msg = e.getMessage();
