...
public class CarbonEventBuilderService implements EventBuilderService, EventReceiver,PassthroughReceiverConfigurator {
    ...
    public void deployDefaultEventBuilder(String streamId,
                                          AxisConfiguration axisConfiguration) throws EventReceiverException{
        try {
            InputEventAdaptorManagerService inputEventAdaptorManagerService = EventBuilderServiceValueHolder.getInputEventAdaptorManagerService();
    ...
    public void activateInactiveEventBuilderConfigurationsForStream(String streamNameWithVersion, int tenantId
    ) throws EventBuilderConfigurationException {
        List<EventBuilderConfigurationFile> fileList = new ArrayList<EventBuilderConfigurationFile>();
