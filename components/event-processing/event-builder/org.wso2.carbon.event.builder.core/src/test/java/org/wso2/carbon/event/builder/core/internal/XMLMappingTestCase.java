...
import org.wso2.carbon.event.builder.core.internal.type.xml.XMLInputMapper;
...
import org.wso2.carbon.event.builder.core.internal.util.TestEventDispatcher;
...
public class XMLMappingTestCase {
    ...
    private XMLInputMapper xmlInputMapper;
    private EventBuilderConfiguration xmlEventBuilderConfig;

    @Before
    public void init() {
        xmlEventBuilderConfig = new EventBuilderConfiguration(new XMLInputMapperFactory());
        ...
        xmlInputMapper = new XMLInputMapper(xmlEventBuilderConfig, new TestEventDispatcher());
    }

    @Test
    public void testCreateMapping() throws MalformedStreamDefinitionException, JaxenException {
        StreamDefinition exportedStreamDefinition = xmlInputMapper.createExportedStreamDefinition();
        List<XPathData> attributeXpathList = new ArrayList<XPathData>();
        xmlInputMapper.createMapping(xmlEventBuilderConfig, exportedStreamDefinition, attributeXpathList);
