...
public class BasicDtoConverter implements DtoConvertible {
    ...
    protected String getInputTransportAdaptorType(String inputTransportAdaptorName, int tenantId)
        ...
        try {
            InputTransportAdaptorConfiguration inputTransportAdaptorConfiguration = inputTransportAdaptorManagerService.getActiveInputTransportAdaptorConfiguration(inputTransportAdaptorName, tenantId);
