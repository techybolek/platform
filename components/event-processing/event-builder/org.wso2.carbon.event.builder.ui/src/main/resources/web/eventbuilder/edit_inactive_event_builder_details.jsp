...
<fmt:bundle basename="org.wso2.carbon.event.builder.ui.i18n.Resources">
    ...
    <%
        ...
        if (stub != null) {
            eventBuilderFile = stub.getInactiveEventBuilderConfigurationContent(eventBuilderFilename);
        }
            ...
            <form name="configform" id="configform" action="index.jsp" method="get">
                ...
                <table class="styledLeft" style="width:100%">
                    ...
                    <tr>
                        <td class="buttonRow">
                            <%
                                if (eventBuilderFilename != null) {
                            %>
                            <button class="button"
                                    onclick="updateConfiguration(document.getElementById('configform'),'<%=eventBuilderFilename%>'); return false;">
                                <fmt:message
                                        key="update"/></button>
