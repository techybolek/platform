...
package org.wso2.carbon.input.transport.adaptor.core.message.config;
...
/**
 * Input transport message configuration details
 */
public class InputTransportAdaptorMessageConfiguration {
    ...
    public InputTransportAdaptorMessageConfiguration() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InputTransportAdaptorMessageConfiguration)) {
            return false;
        }

        InputTransportAdaptorMessageConfiguration that = (InputTransportAdaptorMessageConfiguration) o;
