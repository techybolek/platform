...
<fmt:bundle basename="org.wso2.carbon.input.transport.adaptor.manager.ui.i18n.Resources">
    ...
    <%
        ...
        if (filePath != null) {
            ...
            stub.undeployInactiveInputTransportAdaptorConfiguration(filePath);
    %>
    ...
    <div id="middle">
        <h2><fmt:message key="notdeployed.input.transport.adaptors"/></h2>
        <div id="workArea">
            ...
            <table class="styledLeft">
                ...
                <%
                    InputTransportAdaptorManagerAdminServiceStub stub = InputTransportAdaptorUIUtils.getInputTransportManagerAdminService(config, session, request);
                    InputTransportAdaptorFileDto[] transportDetailsArray = stub.getAllInactiveInputTransportAdaptorConfigurationFile();
