...
<fmt:bundle basename="org.wso2.carbon.input.transport.adaptor.manager.ui.i18n.Resources">
    ...
    <div id="middle">
        <h2><fmt:message key="input.transport.adaptor.details"/> </h2>
            ...
            <table id="transportInputTable" class="styledLeft"
                ...
                <%
                    ...
                    if (transportName != null) {
                        ...
                        InputTransportAdaptorPropertiesDto transportAdaptorPropertiesDto = stub.getActiveInputTransportAdaptorConfiguration(transportName);
