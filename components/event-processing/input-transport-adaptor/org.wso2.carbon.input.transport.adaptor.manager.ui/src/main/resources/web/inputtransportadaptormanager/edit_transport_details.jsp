...
<%
    ...
    if (transportName != null) {
        ...
        inputTransportAdaptorFile = stub.getActiveInputTransportAdaptorConfigurationContent(transportName);

    } else if (transportPath != null) {
        InputTransportAdaptorManagerAdminServiceStub stub = InputTransportAdaptorUIUtils.getInputTransportManagerAdminService(config, session, request);
        inputTransportAdaptorFile = stub.getInactiveInputTransportAdaptorConfigurationContent(transportPath);
