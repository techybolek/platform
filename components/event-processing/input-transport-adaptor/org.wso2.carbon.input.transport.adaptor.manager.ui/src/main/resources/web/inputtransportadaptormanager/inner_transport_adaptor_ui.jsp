...
<fmt:bundle basename="org.wso2.carbon.input.transport.adaptor.manager.ui.i18n.Resources">
    ...
    <script type="text/javascript"
            src="js/create_transport_adaptor_helper.js"></script>
        ...
        <tr>
            ...
            <td><select name="transportTypeFilter"
                ...
                <%
                    ...
                    String[] transportNames = stub.getAllInputTransportAdaptorTypeNames();
                    ...
                    if (transportNames != null) {
                        ...
                        transportAdaptorPropertiesDto = stub.getInputTransportAdaptorProperties(firstTransportName);
