 ...
 */
public final class WSO2EventTransportAdaptorServiceValueHolder {

    private static DataBridgeSubscriberService dataBridgeSubscriberService;
    private static Agent agent;

    private WSO2EventTransportAdaptorServiceValueHolder() {
    }

    public static void registerDataBridgeSubscriberService(
            DataBridgeSubscriberService agentServer) {
        WSO2EventTransportAdaptorServiceValueHolder.dataBridgeSubscriberService = agentServer;
    }
    ...
    public static void registerAgent(Agent agent) {
        WSO2EventTransportAdaptorServiceValueHolder.agent = agent;
    }
