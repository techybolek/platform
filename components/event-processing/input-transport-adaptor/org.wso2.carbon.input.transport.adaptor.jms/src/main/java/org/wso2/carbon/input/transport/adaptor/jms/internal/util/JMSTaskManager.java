...
package org.wso2.carbon.input.transport.adaptor.jms.internal.util;
...
public class JMSTaskManager {
    ...
    private void handleException(String msg, Exception e) {
        log.error(msg, e);
        throw new InputTransportAdaptorEventProcessingException(msg, e);
    }

    private void handleException(String msg) {
        log.error(msg);
        throw new InputTransportAdaptorEventProcessingException(msg);
    }
