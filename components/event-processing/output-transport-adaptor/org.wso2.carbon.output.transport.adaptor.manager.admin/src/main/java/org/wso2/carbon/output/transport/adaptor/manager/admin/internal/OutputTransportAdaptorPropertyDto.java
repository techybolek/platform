 ...
 */
public class OutputTransportAdaptorPropertyDto {
    // property name
    private String key;
    ...
    public OutputTransportAdaptorPropertyDto() {
    }

    public OutputTransportAdaptorPropertyDto(String key, String value) {
        this.key = key;
        this.value = value;
    }
