...
<%
    ...
    if (transportName != null) {
        ...
        stub.undeployActiveOutputTransportAdaptorConfiguration(transportName);
%>
...
<%
    ...
    OutputTransportAdaptorManagerAdminServiceStub stub = OutputTransportAdaptorUIUtils.getOutputTransportManagerAdminService(config, session, request);
    OutputTransportAdaptorConfigurationInfoDto[] transportDetailsArray = stub.getAllActiveOutputTransportAdaptorConfiguration();
    if (transportDetailsArray != null) {
        totalTransportAdaptors = transportDetailsArray.length;
    }

    OutputTransportAdaptorFileDto[] notDeployedTransportAdaptorConfigurationFiles = stub.getAllInactiveOutputTransportAdaptorConfiguration();
...
<div id="middle">
<h2><fmt:message key="available.output.transport.adaptors"/></h2>
<a href="create_transportAdaptor.jsp"
   style="background-image:url(images/add.gif);"
   class="icon-link">
    Add Output Transport Adaptor
</a>
<br/> <br/>
<div id="workArea">
