...
<%
    ...
    if (transportName != null) {
        try {
            ...
            stub.editActiveOutputTransportAdaptorConfiguration(transportAdaptorConfiguration, transportName);
            msg = "true";
        } catch (Exception e) {
            msg = e.getMessage();
        ...
        try {
            // add transport adaptor via admin service
            stub.editInactiveOutputTransportAdaptorConfiguration(transportAdaptorConfiguration, transportPath);
            msg = "true";
        } catch (Exception e) {
            msg = e.getMessage();
