...
<fmt:bundle basename="org.wso2.carbon.output.transport.adaptor.manager.ui.i18n.Resources">
    ...
    <%
        ...
        if (filePath != null) {
            ...
            stub.undeployInactiveOutputTransportAdaptorConfiguration(filePath);
    %>
    ...
    <div id="middle">
        <h2><fmt:message key="notdeployed.output.transport.adaptors"/></h2>
        <div id="workArea">
            ...
            <table class="styledLeft">
                ...
                <%
                    OutputTransportAdaptorManagerAdminServiceStub stub = OutputTransportAdaptorUIUtils.getOutputTransportManagerAdminService(config, session, request);
                    OutputTransportAdaptorFileDto[] transportDetailsArray = stub.getAllInactiveOutputTransportAdaptorConfiguration();
