...
<%@ page import="org.wso2.carbon.output.transport.adaptor.manager.ui.OutputTransportAdaptorUIUtils" %>
<%@ page
...
<%
    ...
    ResourceBundle bundle = ResourceBundle.getBundle(
            "org.wso2.carbon.output.transport.adaptor.manager.ui.i18n.Resources", request.getLocale());
...
<%
    ...
    String outputTransportAdaptorFile = "";
    if (transportName != null) {
        ...
        outputTransportAdaptorFile = stub.getActiveOutputTransportAdaptorConfigurationContent(transportName);

    } else if (transportPath != null) {
        OutputTransportAdaptorManagerAdminServiceStub stub = OutputTransportAdaptorUIUtils.getOutputTransportManagerAdminService(config, session, request);
        outputTransportAdaptorFile = stub.getInactiveOutputTransportAdaptorConfigurationContent(transportPath);

    }

    Boolean loadEditArea = true;
    String transportAdaptorFileConfiguration = outputTransportAdaptorFile;
