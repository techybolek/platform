        ...
        <tr>
            ...
            <td><select name="transportTypeFilter"
                ...
                <%
                    ...
                    String[] transportNames = stub.getOutputTransportAdaptorTypeNames();
                    ...
                    if (transportNames != null) {
                        ...
                        transportAdaptorPropertiesDto = stub.getOutputTransportAdaptorProperties(firstTransportName);
