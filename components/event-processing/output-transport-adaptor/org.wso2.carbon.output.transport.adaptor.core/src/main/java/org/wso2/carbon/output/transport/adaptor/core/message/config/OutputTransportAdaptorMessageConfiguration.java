...
package org.wso2.carbon.output.transport.adaptor.core.message.config;
...
/**
 * Output transport message configuration details
 */
public class OutputTransportAdaptorMessageConfiguration {
    ...
    public OutputTransportAdaptorMessageConfiguration() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OutputTransportAdaptorMessageConfiguration)) {
            return false;
        }

        OutputTransportAdaptorMessageConfiguration that = (OutputTransportAdaptorMessageConfiguration) o;
