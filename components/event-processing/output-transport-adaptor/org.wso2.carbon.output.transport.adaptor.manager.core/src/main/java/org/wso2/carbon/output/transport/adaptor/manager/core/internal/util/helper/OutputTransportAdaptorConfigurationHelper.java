...
public class OutputTransportAdaptorConfigurationHelper {
    ...
    public static OutputTransportAdaptorConfiguration fromOM(OMElement transportConfigOMElement) {
        ...
        if (transportConfigOMElement.getAttributeValue(new QName(OutputTransportAdaptorManagerConstants.TM_ATTR_STATISTICS)) != null && transportConfigOMElement.getAttributeValue(new QName(OutputTransportAdaptorManagerConstants.TM_ATTR_STATISTICS)).equals(OutputTransportAdaptorManagerConstants.TM_VALUE_ENABLE)) {
            transportAdaptorConfiguration.setEnableStatistics(true);
        }else if (transportConfigOMElement.getAttributeValue(new QName(OutputTransportAdaptorManagerConstants.TM_ATTR_STATISTICS)) != null && transportConfigOMElement.getAttributeValue(new QName(OutputTransportAdaptorManagerConstants.TM_ATTR_STATISTICS)).equals(OutputTransportAdaptorManagerConstants.TM_VALUE_DISABLE)) {
            transportAdaptorConfiguration.setEnableStatistics(false);
        }

        if (transportConfigOMElement.getAttributeValue(new QName(OutputTransportAdaptorManagerConstants.TM_ATTR_TRACING)) != null && transportConfigOMElement.getAttributeValue(new QName(OutputTransportAdaptorManagerConstants.TM_ATTR_TRACING)).equals(OutputTransportAdaptorManagerConstants.TM_VALUE_ENABLE)) {
            transportAdaptorConfiguration.setEnableTracing(true);
        }else if (transportConfigOMElement.getAttributeValue(new QName(OutputTransportAdaptorManagerConstants.TM_ATTR_TRACING)) != null && transportConfigOMElement.getAttributeValue(new QName(OutputTransportAdaptorManagerConstants.TM_ATTR_TRACING)).equals(OutputTransportAdaptorManagerConstants.TM_VALUE_DISABLE)) {
    ...
    public static OMElement transportAdaptorConfigurationToOM(
        ...
        if (transportAdaptorConfiguration.isEnableStatistics()) {
            transportAdaptorItem.addAttribute(OutputTransportAdaptorManagerConstants.TM_ATTR_STATISTICS, OutputTransportAdaptorManagerConstants.TM_VALUE_ENABLE,
                                              null);
        }else if (! transportAdaptorConfiguration.isEnableStatistics()) {
            transportAdaptorItem.addAttribute(OutputTransportAdaptorManagerConstants.TM_ATTR_STATISTICS, OutputTransportAdaptorManagerConstants.TM_VALUE_DISABLE,
                                              null);
        }

        if (transportAdaptorConfiguration.isEnableTracing()) {
            transportAdaptorItem.addAttribute(OutputTransportAdaptorManagerConstants.TM_ATTR_TRACING, OutputTransportAdaptorManagerConstants.TM_VALUE_ENABLE,
                                              null);
        }else if (! transportAdaptorConfiguration.isEnableTracing()) {
            transportAdaptorItem.addAttribute(OutputTransportAdaptorManagerConstants.TM_ATTR_TRACING, OutputTransportAdaptorManagerConstants.TM_VALUE_DISABLE,
                                              null);
        }
