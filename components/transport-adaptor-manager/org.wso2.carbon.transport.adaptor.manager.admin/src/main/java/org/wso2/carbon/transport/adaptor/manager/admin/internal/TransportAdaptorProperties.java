...
public class TransportAdaptorProperties {
    ...
    public void setInputTransportPropertyDtos(TransportPropertyDto[] inputTransportPropertyDtos) {
        this.inputTransportPropertyDtos = inputTransportPropertyDtos;
    }
    ...
    public void setOutputTransportPropertyDtos(TransportPropertyDto[] outputTransportPropertyDtos) {
        this.outputTransportPropertyDtos = outputTransportPropertyDtos;
    }
    ...
    public void setCommonTransportPropertyDtos(TransportPropertyDto[] commonTransportPropertyDtos) {
        this.commonTransportPropertyDtos = commonTransportPropertyDtos;
    }
}
