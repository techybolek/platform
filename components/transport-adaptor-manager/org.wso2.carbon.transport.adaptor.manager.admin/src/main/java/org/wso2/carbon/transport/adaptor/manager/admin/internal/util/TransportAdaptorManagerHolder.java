...
public final class TransportAdaptorManagerHolder {
    ...
    private TransportAdaptorManagerHolder() {
    }

    public TransportAdaptorManagerService getTransportAdaptorManagerService() {
        return transportAdaptorManagerService;
    }

    public static TransportAdaptorManagerHolder getInstance() {
        return instance;
    }

    public void registerTransportAdaptorManagerService(
            TransportAdaptorManagerService transportAdaptorManagerService) {
        this.transportAdaptorManagerService = transportAdaptorManagerService;
    }

    public void unRegisterTransportAdaptorManagerService(
            TransportAdaptorManagerService transportAdaptorManagerService) {
        this.transportAdaptorManagerService = null;
    }
