...
public class TransportAdaptorManagerAdminService extends AbstractAdmin {
        ...
        if (checkTransportAdaptorValidity(transportAdaptorName)) {
            try {
                ...
                if (commonAdaptorPropertyDtos.length != 0) {
                    ...
                    transportAdaptorConfiguration.setCommonProperties(transportAdaptorCommonProperties);
                }
    ...
    public TransportAdaptorPropertiesDto getTransportAdaptorConfigurationDetails(
        ...
        try {
            ...
            transportAdaptorConfiguration = transportAdaptorManager.getTransportAdaptorManagerService().
                    getTransportAdaptorConfiguration(transportAdaptorName, tenantId);
    ...
    private TransportAdaptorPropertyDto[] getOutputTransportAdaptorConfiguration(
        ...
        if (transportAdaptorConfiguration != null) {
            ...
            if (transportAdaptorConfiguration.getOutputConfiguration() != null) {
                ...
                TransportAdaptorPropertyDto[] outputTransportAdaptorPropertyDtoArray = new TransportAdaptorPropertyDto[outPropertyList.size()];
                int index = 0;
    ...
    private TransportAdaptorPropertyDto[] getCommonTransportAdaptorConfiguration(
        ...
        if (transportAdaptorConfiguration != null) {
            ...
            List<Property> commonPropertyList = transportAdaptorDto.getAdaptorCommonPropertyList();
            if (transportAdaptorConfiguration.getCommonProperties() != null) {
                Map<String, String> commonTransportProperties = transportAdaptorConfiguration.getCommonProperties();
    ...
    private String getSupportedTransportType(
        ...
        if (transportAdaptorConfiguration.getInputConfiguration() != null && transportAdaptorConfiguration.getOutputConfiguration() == null) {
            return "IN";
        } else if (transportAdaptorConfiguration.getInputConfiguration() == null && transportAdaptorConfiguration.getOutputConfiguration() != null) {
            return "OUT";
        } else {
            return "IN-OUT";
        }
