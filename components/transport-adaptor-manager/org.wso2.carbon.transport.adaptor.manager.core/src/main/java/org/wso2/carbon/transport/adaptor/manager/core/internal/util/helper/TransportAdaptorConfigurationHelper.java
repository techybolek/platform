...
public class TransportAdaptorConfigurationHelper {
    ...
    private TransportAdaptorConfigurationHelper(){}
    ...
    public static OMElement transportAdaptorConfigurationToOM(
        ...
        if (transportAdaptorConfiguration.getCommonProperties() != null) {
            commonTransportAdaptorProperties = transportAdaptorConfiguration.getCommonProperties();
    ...
    public static boolean validateTransportAdaptorConfiguration(
        ...
        if (transportAdaptorConfiguration.getCommonProperties() != null) {
            commonAdaptorConfigurationPropertyList = transportAdaptorConfiguration.getCommonProperties();
        }
