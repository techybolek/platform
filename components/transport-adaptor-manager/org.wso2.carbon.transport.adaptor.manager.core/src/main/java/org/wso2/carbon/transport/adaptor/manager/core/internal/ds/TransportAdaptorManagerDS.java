...
import org.wso2.carbon.transport.adaptor.manager.core.TransportAdaptorDeploymentListenerImpl;
...
public class TransportAdaptorManagerDS {
    ...
    protected void activate(ComponentContext context) {
        ...
        try {
            ...
            TransportAdaptorHolder.getInstance().getTransportAdaptorService().registerTransportAdaptorDeploymentNotifier(new TransportAdaptorDeploymentListenerImpl());
