...
public class EventStatisticsService {
    ...
    public synchronized EventStatisticsMonitor createNewEventStatisticMonitor(int tenantId, String category, String deployment, String element) {

        EventStatisticsManager eventStatisticsManager = EventStatisticsServiceHolder.getInstance().getEventStatisticsManager();
        return eventStatisticsManager.createNewEventStatisticMonitor(tenantId, category, deployment, element);
    }
