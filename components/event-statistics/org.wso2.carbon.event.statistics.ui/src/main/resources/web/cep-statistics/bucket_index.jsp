...
<%@ page import="org.wso2.carbon.event.stub.admin.CEPAdminServiceStub" %>
<%@ page import="org.wso2.carbon.event.stub.admin.internal.xsd.BucketBasicInfoDTO" %>
...
<fmt:bundle basename="org.wso2.carbon.event.statistics.ui.i18n.Resources">
    ...
    <div id="middle">
        ...
        <div id="workArea">
            ...
            <form name="bucketsForm" action="event_delete_buckets_ajaxprocessor.jsp" method="post">
