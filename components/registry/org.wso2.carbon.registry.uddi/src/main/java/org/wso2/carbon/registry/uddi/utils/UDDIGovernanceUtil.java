...
public class UDDIGovernanceUtil {
    ...
    public static UserRegistry getGovernanceRegistry() throws RegistryException {
        ...
        try {
            RegistryService registryService = UDDIGovernanceUtil.getRegistryService();
    ...
    public static void createWSDL(String url) {
        try {
            ...
            UDDIGovernanceUtil.acquireUDDIExternalInvokeLock();
            ...
            UDDIGovernanceUtil.releaseUDDIExternalInvokeLock();
        }
    ...
    public static void createService(BindingTemplate bindingTemplate, String ep) {
        ...
        try {
            if (bindingTemplate.getBusinessService().getServiceNames().get(0) != null) {
            ...
            if (bindingTemplate.getBusinessService().getServiceDescrs().get(0) != null) {
