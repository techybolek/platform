...
public class SingleAssociation extends RestSuper {
	...
	private Log log = LogFactory.getLog(SingleAssociation.class);

	/**
	 * This method add the array of association sent as payload with the request
	 * for the given source
	 * 
	 * @param resourcePath
	 *            - path of the source
	 * @param association
	 *            - Json array of association
	 *            objects[{"target":"<target path>","type"
	 *            :"<association type>"}]
	 * @param username
