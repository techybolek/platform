...
public class RestSuper {
	...
	private Log log = LogFactory.getLog(RestSuper.class);
	 ...
	 * 
	 * @param username
	 *            username of the authorized enduser belongs to the access token
	 * @param tenantID
	 ...
	 * 
	 * @param path
	 *            list of path segment (eg: <_system,governance,sample.xml>
	...
	protected String getTenantID() {
		try {
			int x = CarbonContext.getCurrentContext().getTenantId();
