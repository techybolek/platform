...
import org.wso2.carbon.bam.message.tracer.api.service.MessageTracerApiClient;
...
public class MessageTracerFilter implements Filter {
    ...
    public static final String MESSAGE_TYPE = "ServletFilter";
    ...
    private MessageTracerApiClient messageTracerApiClient;
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        messageTracerApiClient = new MessageTracerApiClient(url, username, password);
    }
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse,
        ...
        if ((servletRequest instanceof HttpServletRequest) && (messageTracerApiClient != null)) {
            ...
            message.setActivityId(bufferedRequest.getHeader(MessageTracerConstants.ACTIVITY_ID_KEY));
    ...
    private Map<String, String> getAdditionalDetails(
        ...
        additionalValues.put(REQUEST_URL, bufferedRequest.getRequestURI());
