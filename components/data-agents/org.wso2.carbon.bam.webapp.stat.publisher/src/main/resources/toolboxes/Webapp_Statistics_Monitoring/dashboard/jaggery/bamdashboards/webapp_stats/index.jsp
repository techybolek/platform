...
<div class="container-fluid">
  <div class="row-fluid">
    ...
    <div class="span10">
      ...
      <div class="hero-unit">
        <iframe id="dashboardWidget-10" class="single-column-gadget" src="gadgets/webapp_stats_for_solution_providers.jag?server=&service&opr&t=Now"></iframe>
      </div>
      <div class="hero-unit">
        <iframe id="dashboardWidget-11" class="single-column-gadget" src="gadgets/webapp_stats_for_platform.jag?server=&service&opr&t=Now"></iframe>
      </div>
