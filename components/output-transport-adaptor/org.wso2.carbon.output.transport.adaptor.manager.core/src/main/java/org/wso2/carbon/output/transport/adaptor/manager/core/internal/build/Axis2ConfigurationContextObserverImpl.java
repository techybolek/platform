package org.wso2.carbon.output.transport.adaptor.manager.core.internal.build;
...
public class Axis2ConfigurationContextObserverImpl
    ...
    public void createdConfigurationContext(ConfigurationContext configurationContext) {
        ...
        System.out.println("--------------- A new Axis2 Configuration context is created for : " +
                           tenantDomain);
        log.info("Loading Output Transport Adaptors Specific to tenant when the tenant logged in");
        try {
            ...
            log.error("Unable to load output transport adaptors ", e);
        } finally {
