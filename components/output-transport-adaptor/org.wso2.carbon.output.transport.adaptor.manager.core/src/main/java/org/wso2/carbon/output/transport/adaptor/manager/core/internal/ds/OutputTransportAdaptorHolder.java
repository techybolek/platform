 ...
 */
public class OutputTransportAdaptorHolder {
    ...
    public void setOutputTransportAdaptorService(
            OutputTransportAdaptorService transportAdaptorService) {
        this.transportAdaptorService = transportAdaptorService;
    }

    public void unSetTOutputTransportAdaptorService() {
        this.transportAdaptorService = null;
    }

    public OutputTransportAdaptorService getOutputTransportAdaptorService() {
