...
function loadTransportProperties(propertyType, transportProperty, transportInputTable,
    ...
    if (transportProperty.localOptions == '') {
        ...
        if (hint != undefined) {
            outputField.innerHTML = '<div class="' + classType + '"> <input style="width:50%" type="' + textPasswordType + '" id="' + requiredElementId + transportPropertyLoop + '" name="' + transportProperty.localKey + '" value="' + defaultValue + '" class="initE"  /> <br/> <div class="sectionHelp">' + hint + '</div></div>';
        }
        else {
            outputField.innerHTML = '<div class="' + classType + '"> <input style="width:50%" type="' + textPasswordType + '" id="' + requiredElementId + transportPropertyLoop + '" name="' + transportProperty.localKey + '" value="' + defaultValue + '" class="initE"  /> </div>';
        }
    }
