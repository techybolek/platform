...
<%
    ...
    if (transportName != null) {
        ...
        stub.removeOutputTransportAdaptorConfiguration(transportName);
%>
...
<%
    ...
    OutputTransportAdaptorManagerAdminServiceStub stub = OutputTransportAdaptorUIUtils.getOutputTransportManagerAdminService(config, session, request);
    OutputTransportAdaptorConfigurationInfoDto[] transportDetailsArray = stub.getAllOutputTransportAdaptorConfigurationInfo();
    if (transportDetailsArray != null) {
        totalTransportAdaptors = transportDetailsArray.length;
    }

    OutputTransportAdaptorFileDto[] notDeployedTransportAdaptorConfigurationFiles = stub.getNotDeployedOutputTransportAdaptorConfigurationFiles();
...
<div id="middle">
<div id="workArea">
    <h3><fmt:message key="available.output.transport.adaptors"/></h3><br/>
    <h5 class="activeAdaptors"><%=totalTransportAdaptors%> <fmt:message
    ...
    <table class="styledLeft">
        ...
        <tbody>
                <%
                for (OutputTransportAdaptorConfigurationInfoDto transportDetails : transportDetailsArray) {
            %>
        <tr>
            <td>
        ...
        <thead>
        <tr>
            <th><fmt:message key="empty.transport.adaptor.header"/></th>
        </tr>
        </thead>
        <tbody>
        <tr>
            <td class="formRaw">
                <table id="noOutputTransportAdaptorInputTable" class="normal-nopadding"
                       style="width:100%">
                    <tbody>
