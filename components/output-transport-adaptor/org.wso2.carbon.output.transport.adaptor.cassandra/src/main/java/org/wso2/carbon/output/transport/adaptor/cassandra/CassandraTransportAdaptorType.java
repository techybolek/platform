...
package org.wso2.carbon.output.transport.adaptor.cassandra;
...
import org.wso2.carbon.output.transport.adaptor.cassandra.internal.util.CassandraTransportAdaptorConstants;
...
public final class CassandraTransportAdaptorType extends AbstractOutputTransportAdaptor {
     ...
     */
    public static CassandraTransportAdaptorType getInstance() {
    ...
    protected void init() {
        ...
        resourceBundle = ResourceBundle.getBundle("org.wso2.carbon.output.transport.adaptor.cassandra.i18n.Resources", Locale.getDefault());
    }
    ...
    private void publishEvent(
        ...
        try {
            ...
            if (outputTransportAdaptorConfiguration.isEnableTracing()) {
                trace.info("At publisher of the Cassandra Transport Adaptor " + event);
            }
    ...
    class TransportAdaptorInfo {
        ...
        private ConcurrentHashMap<OutputTransportAdaptorMessageConfiguration, MessageInfo> messageInfoMap = new ConcurrentHashMap<OutputTransportAdaptorMessageConfiguration, MessageInfo>();
        ...
        public ConcurrentHashMap<OutputTransportAdaptorMessageConfiguration, MessageInfo> getMessageInfoMap() {
