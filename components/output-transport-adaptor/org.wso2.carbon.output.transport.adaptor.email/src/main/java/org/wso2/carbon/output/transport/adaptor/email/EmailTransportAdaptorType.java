...
public final class EmailTransportAdaptorType extends AbstractOutputTransportAdaptor {
    ...
    public void publish(
        ...
        if (emailIds != null) {
            for (String email : emailIds) {
                threadPoolExecutor.submit(new EmailSender(email, emailSenderConfiguration.getSubject(), (String) message, outputTransportAdaptorConfiguration.isEnableTracing(), outputTransportAdaptorConfiguration.isEnableStatistics()));
            }
        }
    }
    ...
    class EmailSender implements Runnable {
        ...
        boolean enabledStatistics;

        EmailSender(String to, String subject, String body, boolean enabledTracing,
                    boolean enabledStatistics) {
            this.to = to;
        ...
        public void run() {
            ...
            try {
                ...
                if (this.enabledTracing) {
                    trace.info("At publisher of the Email Transport Adaptor " + body);
                }
