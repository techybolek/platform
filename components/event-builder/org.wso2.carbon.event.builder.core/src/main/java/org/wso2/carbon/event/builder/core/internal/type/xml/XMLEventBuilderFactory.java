...
public class XMLEventBuilderFactory implements EventBuilderFactory {


    @Override
    public InputMapping constructInputMappingFromOM(OMElement omElement) {
        return XMLBuilderConfigBuilder.getInstance().fromOM(omElement);
    }

    @Override
    public OMElement constructOMFromInputMapping(
            InputMapping inputMapping, OMFactory factory) {
        return XMLBuilderConfigBuilder.getInstance().inputMappingToOM(inputMapping, factory);
    }
    ...
    public EventBuilder constructEventBuilder(AxisConfiguration axisConfiguration,
        ...
        return new XMLInputEventBuilder(eventBuilderConfiguration, axisConfiguration);
    }
}
