...
public class EventBuilderConstants {
    ...
    public static final String EB_ATTR_BATCH_PROCESSING_ENABLED_TYPE = "batchProcessingEnabled";
    ...
    public static final Map<InputTransportAdaptorDto.MessageType, String> MESSAGE_TYPE_STRING_MAP = Collections.unmodifiableMap(new HashMap<InputTransportAdaptorDto.MessageType, String>() {{
        put(InputTransportAdaptorDto.MessageType.WSO2EVENT, EB_WSO2EVENT_MAPPING_TYPE);
        put(InputTransportAdaptorDto.MessageType.XML, EB_XML_MAPPING_TYPE);
        put(InputTransportAdaptorDto.MessageType.MAP, EB_MAP_MAPPING_TYPE);
        put(InputTransportAdaptorDto.MessageType.TEXT, EB_TEXT_MAPPING_TYPE);
        put(InputTransportAdaptorDto.MessageType.JSON, EB_JSON_MAPPING_TYPE);
    }});

    public static final String EVENT_TRACE_LOGGER = "EVENT_TRACE_LOGGER";
    public static final String EB_ATTR_TRACE_ENABLED = "traceEnabled";
    public static final String EB_ATTR_STATISTICS_ENABLED = "statisticsEnabled";
    public static final String CHARSET_UTF8 = "UTF-8";
    public static final String TRUE_STRING_CONST = "true";

    public static final String ITA_EMAIL = "email";

    public static final String REGEX_FOR_LINE_START = ".*\\b";
    public static final String REGEX_FOR_LINE_END = "\\b.*";
}
