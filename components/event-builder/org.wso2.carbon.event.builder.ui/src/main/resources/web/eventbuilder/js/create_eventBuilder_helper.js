...
function loadTransportMessageProperty(messageProperty, eventBuilderInputTable, propertyIndex,
    ...
    inputField.innerHTML = '<input style="width:50%" type="' + inputElementType + '" id="' + elementIdPrefix + propertyIndex + '" name="' + messageProperty.localKey + '" value="' + defaultValue + '" class="initE" /> <br/> ' + htmlForHint;
}
