...
public class EventBuilderAdminServiceValueHolder {
    ...
    private static TransportAdaptorManagerService transportAdaptorManagerService;
    ...
    public static void registerTransportAdaptorManagerService(TransportAdaptorManagerService transportAdaptorManagerService) {
        EventBuilderAdminServiceValueHolder.transportAdaptorManagerService = transportAdaptorManagerService;
    }

    public static TransportAdaptorManagerService getTransportAdaptorManagerService() {
        return EventBuilderAdminServiceValueHolder.transportAdaptorManagerService;
    }
}
