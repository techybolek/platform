...
public class SetupCRUDParams extends AbstractConnector {
	public void connect(MessageContext messageContext) {
		setDefaultValue(messageContext, SalesforceUtil.SALESFORCE_CRUD_PREFIX,
				SalesforceUtil.SALESFORCE_CRUD_ALLORNONE, "1");
		setDefaultValue(messageContext, SalesforceUtil.SALESFORCE_CRUD_PREFIX,
				SalesforceUtil.SALESFORCE_CRUD_ALLOWFIELDTRUNCATE, "0");
		setDefaultValue(messageContext, SalesforceUtil.SALESFORCE_CRUD_PREFIX,
				SalesforceUtil.SALESFORCE_EXTERNALID, "Id");
	}

	private void setDefaultValue(MessageContext messageContext, String strParamPrefix,
