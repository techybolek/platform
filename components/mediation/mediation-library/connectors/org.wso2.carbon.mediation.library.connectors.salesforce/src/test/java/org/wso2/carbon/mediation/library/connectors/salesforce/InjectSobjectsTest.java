...
public class InjectSobjectsTest extends TestCase {
	...
	public static void testCreateConnect() throws AxisFault{
		...
		testConnect("create", SalesforceUtil.SALESFORCE_CREATE_SOBJECTS, new SetupCreateSobjects());
	}
	...
	public static void testUpdateConnect() throws AxisFault{
        ...
        testCtx.setEnvelope(envelope);		
		testConnect("update", SalesforceUtil.SALESFORCE_UPDATE_SOBJECTS, new SetupUpdateSobjects());
	}
	...
	public static void testUpsertConnect() throws AxisFault{
        ...
        testCtx.setEnvelope(envelope);		
		testConnect("upsert", SalesforceUtil.SALESFORCE_UPSERT_SOBJECTS, new SetupUpsertSobjects());
	}
