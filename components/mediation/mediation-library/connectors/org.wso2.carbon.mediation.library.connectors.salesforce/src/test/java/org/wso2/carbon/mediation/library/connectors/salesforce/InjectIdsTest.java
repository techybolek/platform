...
public class InjectIdsTest extends TestCase {
	...
	public static void testDeleteConnect() throws AxisFault{
		...
		testConnect("delete", SalesforceUtil.SALESFORCE_DELETE_SOBJECTS, new SetupDeleteSobjects());
	}
	...
	public static void testUndeleteConnect() throws AxisFault{
        ...
        testCtx.setEnvelope(envelope);		
		testConnect("undelete", SalesforceUtil.SALESFORCE_DELETE_SOBJECTS, new SetupUndelete());
	}	
	...
	public static void testEmptyRecycleBinConnect() throws AxisFault{
        ...
        testCtx.setEnvelope(envelope);		
		testConnect("emptyRecycleBin", SalesforceUtil.SALESFORCE_DELETE_SOBJECTS, new SetupEmptyRecycleBin());
	}
