...
public class SetupCRUDParamsTest extends TestCase {
	...
	public static void testSetupCRUDDefaultParams() throws AxisFault{
		...
		assertEquals("1", synCtx.getProperty(SalesforceUtil.SALESFORCE_CRUD_ALLORNONE));
		assertEquals("0", synCtx.getProperty(SalesforceUtil.SALESFORCE_CRUD_ALLOWFIELDTRUNCATE));
		assertEquals("Id", synCtx.getProperty(SalesforceUtil.SALESFORCE_UPDATE_EXTERNALID));
	...
	public static void testSetupCRUDParams() throws AxisFault{
		...
		collection.add(SalesforceUtil.SALESFORCE_UPDATE_EXTERNALID);
		synCtx.setProperty(TEST_TEMPLATE + ":" + SalesforceUtil.SALESFORCE_CRUD_ALLORNONE, new Value("0"));
		synCtx.setProperty(TEST_TEMPLATE + ":" + SalesforceUtil.SALESFORCE_CRUD_ALLOWFIELDTRUNCATE, new Value("1"));
		synCtx.setProperty(TEST_TEMPLATE + ":" + SalesforceUtil.SALESFORCE_UPDATE_EXTERNALID, new Value("Name"));
		...
		assertEquals("0", synCtx.getProperty(SalesforceUtil.SALESFORCE_CRUD_ALLORNONE));
		assertEquals("1", synCtx.getProperty(SalesforceUtil.SALESFORCE_CRUD_ALLOWFIELDTRUNCATE));
		assertEquals("Name", synCtx.getProperty(SalesforceUtil.SALESFORCE_UPDATE_EXTERNALID));
