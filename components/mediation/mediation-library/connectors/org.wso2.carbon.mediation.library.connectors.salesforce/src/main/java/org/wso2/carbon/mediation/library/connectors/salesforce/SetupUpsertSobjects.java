...
public class SetupUpsertSobjects extends AbstractConnector {
	 public void connect(MessageContext synCtx) {
	        ...
	        salesforceUtil.addSobjects("upsert", SalesforceUtil.SALESFORCE_UPSERT_SOBJECTS, synCtx, synLog, (String)synCtx.getProperty(SalesforceUtil.SALESFORCE_UPDATE_EXTERNALID));	           
