...
import static org.wso2.carbon.mediation.library.connectors.jira.JiraConstants.FUNC_REQD_USERNAME;

import org.apache.synapse.MessageContext;
import org.wso2.carbon.mediation.library.connectors.jira.JiraGetUserMediator;

/**
 *
 */
public class JiraGetUserTemplate extends JiraGetUserMediator {
	@Override
	public boolean mediate(MessageContext synCtx) {
		fillAuthParams(synCtx, this);
		setRequiredUsername(lookupFunctionParam(synCtx, FUNC_REQD_USERNAME));
