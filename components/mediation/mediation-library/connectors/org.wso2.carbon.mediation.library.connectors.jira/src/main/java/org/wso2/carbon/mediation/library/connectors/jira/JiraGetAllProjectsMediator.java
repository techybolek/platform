...
import static org.wso2.carbon.mediation.library.connectors.jira.JiraConstants.CONTEXT_PROJECTS;
...
public class JiraGetAllProjectsMediator extends JiraMediator {
    ...
    public boolean mediate(MessageContext synCtx) {
		...
		synCtx.setProperty(CONTEXT_PROJECTS, projectList);
