...
import static org.wso2.carbon.mediation.library.connectors.jira.JiraConstants.FUNC_ROLE_URI;

import org.apache.synapse.MessageContext;
import org.wso2.carbon.mediation.library.connectors.jira.JiraGetProjectRoleMediator;

/**
 *
 */
public class JiraGetProjectRoleTemplate extends JiraGetProjectRoleMediator {
	@Override
	public boolean mediate(MessageContext synCtx) {
		fillAuthParams(synCtx, this);
		setRoleUri(lookupFunctionParam(synCtx, FUNC_ROLE_URI));
