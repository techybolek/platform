...
import static org.wso2.carbon.mediation.library.connectors.jira.JiraConstants.FUNC_PROJECT_KEY;

import org.apache.synapse.MessageContext;
import org.wso2.carbon.mediation.library.connectors.jira.JiraGetProjectMediator;

/**
 *
 */
public class JiraGetProjectTemplate extends JiraGetProjectMediator {
	@Override
	public boolean mediate(MessageContext synCtx) {
		fillAuthParams(synCtx, this);
		setProjectKey(lookupFunctionParam(synCtx, FUNC_PROJECT_KEY));
