	...
	public void connect(MessageContext messageContext) throws ConnectException {
		try {
			...
			if (spreadsheetName == null || "".equals(spreadsheetName.trim())
				...
				log.info("Please make sure you have given a valid input for the spreadsheet, worksheet old name and worksheet new name");
				return;
			}
			...
			if(worksheetColumns != null) {
				...
				log.info("Please enter a valid number for row count and column count");
			}
