	...
	public void connect(MessageContext messageContext) throws ConnectException {
		try {
			...
			if ((worksheetName == null || "".equals(worksheetName.trim()))
				...
				log.info("Please make sure you have given a valid input for the worksheet or spreadsheet name");
				return;
			}
	        ...
	        OMElement searchResult  = factory.createOMElement("getAuthors", ns);        
