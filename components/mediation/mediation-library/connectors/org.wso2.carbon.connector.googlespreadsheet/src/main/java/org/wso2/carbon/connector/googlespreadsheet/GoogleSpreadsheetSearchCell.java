	...
	public void connect(MessageContext messageContext) throws ConnectException {
		try {
			...
			if (worksheetName == null || "".equals(worksheetName.trim())
				...
				log.info("Please make sure you have given a valid input for the worksheet, spreadsheet and search string");
				return;
			}
	        ...
	        OMElement searchResult  = factory.createOMElement("searchresult", ns);        
