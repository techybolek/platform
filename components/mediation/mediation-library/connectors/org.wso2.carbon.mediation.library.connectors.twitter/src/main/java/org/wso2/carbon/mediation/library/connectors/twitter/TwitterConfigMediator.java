...
public class TwitterConfigMediator extends AbstractConnector {

	private static Log log = LogFactory.getLog(TwitterConfigMediator.class);
	...
	public void connect(MessageContext messageContext) throws ConnectException {
		try {
			String consumerKey = TwitterMediatorUtils.lookupFunctionParam(messageContext,
					CONSUMER_KEY);
			String consumerSecret = TwitterMediatorUtils.lookupFunctionParam(messageContext,
					CONSUMER_SECRET);
			String accessToken = TwitterMediatorUtils.lookupFunctionParam(messageContext,
					ACCESS_TOKEN);
			String accessTokenSecret = TwitterMediatorUtils.lookupFunctionParam(messageContext,
					ACCESS_TOKEN_SECRET);

			TwitterMediatorUtils.storeLoginUser(messageContext, consumerKey, consumerSecret,
