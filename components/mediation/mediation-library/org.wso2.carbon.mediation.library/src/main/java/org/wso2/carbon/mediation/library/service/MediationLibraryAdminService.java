...
public class MediationLibraryAdminService extends AbstractServiceBusAdmin {
    ...
    private void addImport(String xml) throws AxisFault {
        try {
            ...
            if (synapseImport != null && synapseImport.getName() != null) {
                ...
                synapseConfiguration.addSynapseImport(synapseImport.getName(),
                                                      synapseImport);
    ...
    public void addImport(String libName, String packageName) throws AxisFault {
        ...
        if(impEl != null){
            ...
            handleException(log,"Could not add Synapse Import. Invalid import params for libName : "
     ...
     *
     * @param qualifiedName name of the message processor
     ...
     *
     * @param importQualifiedName of the MessageProcessor  to be deleted
    ...
    public void deleteImport(String importQualifiedName) throws AxisFault {
        ...
        if (configuration.getSynapseImports().containsKey(importQualifiedName)) {
            ...
            Library synLib = getSynapseConfiguration().getSynapseLibraries().get(importQualifiedName);
            if (synLib != null) {
            ...
            pm.deleteItem(synapseImport.getName(),
                    fileName, ServiceBusConstants.ITEM_TYPE_IMPORT);

        } else {
            handleException(log, "Library Import " + importQualifiedName + " does not exist", null);
        }
    }
