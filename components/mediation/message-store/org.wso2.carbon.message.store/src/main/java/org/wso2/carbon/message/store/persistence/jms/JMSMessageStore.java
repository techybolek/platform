            ...
            try {
                ...
                if (jndiContext.getEnvironment() != null) {
                    if (jndiContext.getEnvironment().get(JMSConstants.NAMING_FACTORY_INITIAL) != null) {
                        initialContextProperties.put(JMSConstants.NAMING_FACTORY_INITIAL, jndiContext.getEnvironment().get(JMSConstants.NAMING_FACTORY_INITIAL));
                    }
                    if (jndiContext.getEnvironment().get(JMSConstants.CONNECTION_STRING) != null) {
                        initialContextProperties.put(JMSConstants.CONNECTION_STRING, jndiContext.getEnvironment().get(JMSConstants.CONNECTION_STRING));
                    }
                     if(jndiContext.getEnvironment().get(JMSConstants.PROVIDER_URL) != null){
                        initialContextProperties.put(JMSConstants.PROVIDER_URL, jndiContext.getEnvironment().get(JMSConstants.PROVIDER_URL));
                    }
                }
                initialContextProperties.put(JMSConstants.QUEUE_PREFIX + jmsMessageStoreDestination, jmsMessageStoreDestination);
