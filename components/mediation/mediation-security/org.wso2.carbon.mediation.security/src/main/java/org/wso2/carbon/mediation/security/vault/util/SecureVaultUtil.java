...
public class SecureVaultUtil {
	...
	public static Properties loadProperties() {
		...
		String filePath = carbonHome + File.separator + SecureVaultConstants.REPOSITORY_DIR + File.separator
				+ SecureVaultConstants.CONF_DIR + File.separator + SecureVaultConstants.SECURITY_DIR + File.separator
