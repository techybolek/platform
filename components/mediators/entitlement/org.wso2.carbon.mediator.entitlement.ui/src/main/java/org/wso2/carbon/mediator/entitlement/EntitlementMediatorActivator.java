 ...
 *
 */
public class EntitlementMediatorActivator implements BundleActivator {

    private static final Log log = LogFactory.getLog(EntitlementMediatorActivator.class);
    ...
    public void stop(BundleContext bundleContext) throws Exception {
        if (log.isDebugEnabled()) {
            log.debug("Stopped the entitlement mediator component ...");
        }
    }
}
