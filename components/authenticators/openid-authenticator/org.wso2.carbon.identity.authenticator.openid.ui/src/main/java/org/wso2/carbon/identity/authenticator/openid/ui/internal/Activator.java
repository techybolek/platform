 ...
 * under the License.
 */
package org.wso2.carbon.identity.authenticator.openid.ui.internal;
...
import org.wso2.carbon.identity.authenticator.openid.ui.OpenIDUIAuthenticator;
...
public class Activator implements BundleActivator {
    ...
    public void start(BundleContext bc) throws Exception {
        OpenIDUIAuthenticator authenticator = new OpenIDUIAuthenticator();
        ...
        log.info("OpenID Authenticator enabled in the system");
    }
