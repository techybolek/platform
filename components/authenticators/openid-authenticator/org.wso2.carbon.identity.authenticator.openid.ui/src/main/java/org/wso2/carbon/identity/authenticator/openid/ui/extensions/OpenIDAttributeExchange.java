            ...
            if (authSuccess.hasExtension(FetchResponse.OPENID_NS_AX)) {
                ...
                for (Object alias : aliases) {
                    ...
                    if (values != null && !values.isEmpty()) {
                        ...
                        claim.setClaimUri((String) values.get(0));
                        claimList.add(claim);
                    }
                }
            } else if (authSuccess.hasExtension(OpenIDConstants.ExchangeAttributes.NS_AX)) {
                fetchReponse = (FetchResponse) authSuccess
                        .getExtension(OpenIDConstants.ExchangeAttributes.NS_AX);
                aliases = fetchReponse.getAttributeAliases();
                attributeTypes = fetchReponse.getAttributeTypes();
