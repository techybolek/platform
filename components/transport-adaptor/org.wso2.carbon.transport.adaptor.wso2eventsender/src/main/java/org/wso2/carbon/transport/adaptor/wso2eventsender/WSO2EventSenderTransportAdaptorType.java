...
package org.wso2.carbon.transport.adaptor.wso2eventsender;
...
import org.wso2.carbon.transport.adaptor.wso2eventsender.ds.WSO2EventSenderTransportAdaptorServiceValueHolder;
import org.wso2.carbon.transport.adaptor.wso2eventsender.util.WSO2EventSenderTransportAdaptorConstants;
...
public final class WSO2EventSenderTransportAdaptorType extends AbstractTransportAdaptor
    ...
    protected String getName() {
        return WSO2EventSenderTransportAdaptorConstants.TRANSPORT_TYPE_WSO2EVENTSENDER;
    }
    ...
    protected void init() {
        ...
        resourceBundle = ResourceBundle.getBundle("org.wso2.carbon.transport.adaptor.wso2eventsender.i18n.Resources", Locale.getDefault());
    }
    ...
    protected List<Property> getCommonAdaptorConfig() {
        ...
        Property ipProperty = new Property(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_RECEIVER_URL);
        ipProperty.setDisplayName(
                resourceBundle.getString(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_RECEIVER_URL));
        ipProperty.setRequired(true);
        ipProperty.setHint(resourceBundle.getString(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_HINT_RECEIVER_URL));

        // set authenticator url of transport
        Property authenticatorIpProperty = new Property(WSO2EventSenderTransportAdaptorConstants.
                                                                TRANSPORT_CONF_WSO2EVENTSENDER_PROP_AUTHENTICATOR_URL);
        authenticatorIpProperty.setDisplayName(
                resourceBundle.getString(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_AUTHENTICATOR_URL));
        authenticatorIpProperty.setRequired(false);
        authenticatorIpProperty.setHint(resourceBundle.getString(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_HINT_AUTHENTICATOR_URL));


        // set connection user name as property
        Property userNameProperty = new Property(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_USER_NAME);
        userNameProperty.setRequired(true);
        userNameProperty.setDisplayName(
                resourceBundle.getString(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_USER_NAME));
        userNameProperty.setHint(resourceBundle.getString(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_HINT_USER_NAME));

        // set connection password as property
        Property passwordProperty = new Property(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_PASSWORD);
        passwordProperty.setRequired(true);
        passwordProperty.setSecured(true);
        passwordProperty.setDisplayName(
                resourceBundle.getString(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_PASSWORD));
        passwordProperty.setHint(resourceBundle.getString(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_HINT_PASSWORD));
    ...
    private AsyncDataPublisher createDataPublisher(
        ...
        if (null != adaptorCommonProperties.get(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_AUTHENTICATOR_URL) && adaptorCommonProperties.get(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_AUTHENTICATOR_URL).length() > 0) {
            dataPublisher = new AsyncDataPublisher(adaptorCommonProperties.get(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_AUTHENTICATOR_URL),
                                                   adaptorCommonProperties.get(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_RECEIVER_URL),
                                                   adaptorCommonProperties.get(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_USER_NAME),
                                                   adaptorCommonProperties.get(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_PASSWORD),
                                                   agent);
        } else {
            dataPublisher = new AsyncDataPublisher(adaptorCommonProperties.get(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_RECEIVER_URL),
                                                   adaptorCommonProperties.get(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_USER_NAME),
                                                   adaptorCommonProperties.get(WSO2EventSenderTransportAdaptorConstants.TRANSPORT_CONF_WSO2EVENTSENDER_PROP_PASSWORD),
                                                   agent);
        }
