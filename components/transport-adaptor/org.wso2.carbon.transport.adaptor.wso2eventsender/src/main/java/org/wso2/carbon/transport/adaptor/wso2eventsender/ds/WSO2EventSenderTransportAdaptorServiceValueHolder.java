...
public final class WSO2EventSenderTransportAdaptorServiceValueHolder {
    ...
    public static void registerAgentTransportRegistrationService(
        ...
        WSO2EventSenderTransportAdaptorServiceValueHolder.agentTransportAdaptorRegistrationService = agentTransportAdaptorRegistrationService;
    }

    public static TransportAdaptorRegistrationService getAgentTransportRegistrationService() {
        return WSO2EventSenderTransportAdaptorServiceValueHolder.agentTransportAdaptorRegistrationService;
    }
