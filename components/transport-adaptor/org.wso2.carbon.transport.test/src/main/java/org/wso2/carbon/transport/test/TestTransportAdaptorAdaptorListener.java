...
public class TestTransportAdaptorAdaptorListener implements TransportAdaptorListener {
    ...
    @Override
    public void addEventDefinition(Object object) throws TransportEventProcessingException {
        System.out.println(" Add Definition ==> " + object);
    }

    @Override
    public void removeEventDefinition(Object object) throws TransportEventProcessingException {
     ...
     *
     */
    public void onEvent(Object object) throws TransportEventProcessingException {
