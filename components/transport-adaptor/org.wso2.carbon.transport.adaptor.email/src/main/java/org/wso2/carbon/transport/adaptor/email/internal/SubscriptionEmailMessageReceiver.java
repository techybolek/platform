...
public class SubscriptionEmailMessageReceiver extends AbstractInMessageReceiver {
    ...
    public void addTransportAdaptorListener(String subscriptionId, TransportAdaptorListener transportAdaptorListener) {
    ...
    protected void invokeBusinessLogic(MessageContext messageContext) throws AxisFault {
        ...
        try {
            OMElement omMessage = AXIOMUtil.stringToOM(message);
            try {
            ...
            log.warn("Message is not an xml :" + message);
        }
    }
}