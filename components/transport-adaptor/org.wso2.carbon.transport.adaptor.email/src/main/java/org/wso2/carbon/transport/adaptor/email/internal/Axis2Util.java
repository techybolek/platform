...
* under the License.
*/
package org.wso2.carbon.transport.adaptor.email.internal;
...
public class Axis2Util {
    ...
    public static AxisService registerAxis2EmailService(InputTransportMessageConfiguration inputTransportMessageConfiguration, TransportAdaptorListener transportAdaptorListener, InputTransportAdaptorConfiguration inputTransportAdaptorConfiguration,
        ...
        if (axisService == null) {
            ...
            axisService.addParameter(EmailTransportAdaptorConstants.TRANSPORT_CONF_RECEIVING_EMAIL_ADDRESS, inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.TRANSPORT_CONF_RECEIVING_EMAIL_ADDRESS));
            axisService.addParameter(EmailTransportAdaptorConstants.TRANSPORT_CONF_RECEIVING_EMAIL_PROTOCOL, inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.TRANSPORT_CONF_RECEIVING_EMAIL_PROTOCOL));
            axisService.addParameter(EmailTransportAdaptorConstants.TRANSPORT_CONF_RECEIVING_EMAIL_POLL_INTERVAL, inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.TRANSPORT_CONF_RECEIVING_EMAIL_POLL_INTERVAL));
            axisService.addParameter("mail." + inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.BROKER_CONF_EMAIL_PROTOCOL) + ".host", inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.TRANSPORT_CONF_RECEIVING_EMAIL_PROTOCOL_HOST));
            axisService.addParameter("mail." + inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.BROKER_CONF_EMAIL_PROTOCOL) + ".port", inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.TRANSPORT_CONF_RECEIVING_EMAIL_PROTOCOL_PORT));
            axisService.addParameter("mail." + inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.BROKER_CONF_EMAIL_PROTOCOL) + ".user", inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.TRANSPORT_CONF_RECEIVING_EMAIL_USERNAME));
            axisService.addParameter("mail." + inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.BROKER_CONF_EMAIL_PROTOCOL) + ".password", inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.TRANSPORT_CONF_RECEIVING_EMAIL_PASSWORD));
            axisService.addParameter("mail." + inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.BROKER_CONF_EMAIL_PROTOCOL) + ".socketFactory.class", inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.TRANSPORT_CONF_RECEIVING_EMAIL_SOCKET_FACTORY_CLASS));
            axisService.addParameter("mail." + inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.BROKER_CONF_EMAIL_PROTOCOL) + ".socketFactory.fallback", inputTransportAdaptorConfiguration.getInputProperties().get(EmailTransportAdaptorConstants.TRANSPORT_CONF_RECEIVING_EMAIL_SOCKET_FACTORY_FALLBACK));
...
//            <parameter name="transport.mail.ContentType">application/xml</parameter>
        ...
        String operationName = inputTransportMessageConfiguration.getInputMessageProperties().get(EmailTransportAdaptorConstants.TRANSPORT_MESSAGE_RECEIVING_EMAIL_SUBJECT);
...
//        AxisEvent serviceUpdateEvent = new AxisEvent(AxisEvent.SERVICE_DEPLOY,axisService);
     ...
     * @throws AxisFault
     */
    public static void removeEmailServiceOperation(InputTransportMessageConfiguration inputTransportMessageConfiguration,
