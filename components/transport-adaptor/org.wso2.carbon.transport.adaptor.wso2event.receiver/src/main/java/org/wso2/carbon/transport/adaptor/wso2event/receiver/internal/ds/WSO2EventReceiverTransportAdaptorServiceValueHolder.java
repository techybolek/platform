...
package org.wso2.carbon.transport.adaptor.wso2event.receiver.internal.ds;
...
public final class WSO2EventReceiverTransportAdaptorServiceValueHolder {
    ...
    private static TransportAdaptorRegistrationService wso2EventReceiverTransportAdaptorRegistrationService;

    private WSO2EventReceiverTransportAdaptorServiceValueHolder() {
    }

    public static void registerAgentTransportRegistrationService(
            TransportAdaptorRegistrationService wso2EventReceiverTransportAdaptorRegistrationService) {
        WSO2EventReceiverTransportAdaptorServiceValueHolder.wso2EventReceiverTransportAdaptorRegistrationService = wso2EventReceiverTransportAdaptorRegistrationService;
    }

    public static TransportAdaptorRegistrationService getAgentTransportRegistrationService() {
        return WSO2EventReceiverTransportAdaptorServiceValueHolder.wso2EventReceiverTransportAdaptorRegistrationService;
    }
