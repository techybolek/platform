 ...
 */
public final class WSEventLocalTransportAdaptorServiceValueHolder {
    ...
    private WSEventLocalTransportAdaptorServiceValueHolder() {
    }
    ...
    public static void registerTransportRegistrationService(
        ...
        WSEventLocalTransportAdaptorServiceValueHolder.transportAdaptorRegistrationService = transportAdaptorRegistrationService;
    }

    public static TransportAdaptorRegistrationService getTransportRegistrationService() {
        return WSEventLocalTransportAdaptorServiceValueHolder.transportAdaptorRegistrationService;
    }

    public static void registerEventBroker(EventBroker eventBroker) {
        WSEventLocalTransportAdaptorServiceValueHolder.eventBroker = eventBroker;
    }

    public static EventBroker getEventBroker() {
        return WSEventLocalTransportAdaptorServiceValueHolder.eventBroker;
    }
}
