 ...
 */
public final class CassandraTransportAdaptorServiceValueHolder {

    private static TransportAdaptorRegistrationService agentTransportAdaptorRegistrationService;

    private CassandraTransportAdaptorServiceValueHolder() {
    }
    ...
    public static void registerAgentTransportRegistrationService(
        ...
        CassandraTransportAdaptorServiceValueHolder.agentTransportAdaptorRegistrationService = agentTransportAdaptorRegistrationService;
    }

    public static TransportAdaptorRegistrationService getAgentTransportRegistrationService() {
        return agentTransportAdaptorRegistrationService;
    }
