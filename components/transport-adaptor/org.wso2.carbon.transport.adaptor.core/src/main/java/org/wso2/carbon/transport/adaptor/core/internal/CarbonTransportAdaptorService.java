...
public class CarbonTransportAdaptorService implements TransportAdaptorService {
    ...
    private TransportAdaptorDeploymentListener transportAdaptorDeploymentListener;
    ...
    public void registerTransportAdaptor(AbstractTransportAdaptor abstractTransportAdaptor) {
        ...
        if(transportAdaptorDeploymentListener != null){
            transportAdaptorDeploymentListener.tryTransportAdaptorDeployment();
        }
    }
    ...
    @Override
    public void registerTransportAdaptorDeploymentNotifier(TransportAdaptorDeploymentListener transportAdaptorDeploymentListener){
        this.transportAdaptorDeploymentListener = transportAdaptorDeploymentListener;
    }
}
