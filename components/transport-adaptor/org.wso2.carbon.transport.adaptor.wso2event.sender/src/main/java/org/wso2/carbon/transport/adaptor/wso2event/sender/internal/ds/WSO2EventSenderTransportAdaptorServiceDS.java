...
package org.wso2.carbon.transport.adaptor.wso2event.sender.internal.ds;
...
import org.wso2.carbon.transport.adaptor.wso2event.sender.WSO2EventSenderTransportAdaptorFactory;
...
public class WSO2EventSenderTransportAdaptorServiceDS {

    private static final Log log = LogFactory.getLog(WSO2EventSenderTransportAdaptorServiceDS.class);
    ...
    protected void activate(ComponentContext context) {
        ...
        try {
            WSO2EventSenderTransportAdaptorServiceValueHolder.getAgentTransportRegistrationService().registerTransportAdaptor(WSO2EventSenderTransportAdaptorFactory.class.getName());
            log.info("Successfully deployed the WSO2EventSender transport service");
    ...
    protected void setTransportAdaptorRegistrationService(
        ...
        WSO2EventSenderTransportAdaptorServiceValueHolder.registerAgentTransportRegistrationService(transportAdaptorRegistrationService);
    }
    ...
    protected void setDataBridgeSubscriberService(
        ...
        WSO2EventSenderTransportAdaptorServiceValueHolder.registerDataBridgeSubscriberService(dataBridgeSubscriberService);
    }
    ...
    protected void setAgent(Agent agent) {
        WSO2EventSenderTransportAdaptorServiceValueHolder.registerAgent(agent);
    }
