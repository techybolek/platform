...
public class EventProcessorServiceDS {
    ...
    protected void activate(ComponentContext context) {
        try {
            EventProcessorService eventProcessorService = new CarbonEventProcessorService();
            EventProcessorValueHolder.registerEventProcessorService(eventProcessorService);
