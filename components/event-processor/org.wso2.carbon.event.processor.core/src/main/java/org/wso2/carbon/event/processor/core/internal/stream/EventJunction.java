...
public class EventJunction {
    ...
    private boolean subscribedToBuilder;
    ...
    public boolean addConsumer(EventConsumer consumer) {
    ...
    public boolean addProducer(EventProducer listener) {
    ...
    public boolean isSubscribedToBuilder() {
        return subscribedToBuilder;
    }

    public void setSubscribedToBuilder(boolean subscribedToBuilder) {
        this.subscribedToBuilder = subscribedToBuilder;
    }
}
