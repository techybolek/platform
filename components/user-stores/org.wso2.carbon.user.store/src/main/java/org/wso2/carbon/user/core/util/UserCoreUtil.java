...
public final class UserCoreUtil {
	 ...
	 */
	private static ThreadLocal threadLocalToSetDomain = new ThreadLocal();
	...
	public static String getPolicyFriendlyRandomPassword(String username, int length)
		...
		try {
			...
			throw new UserStoreException("Error while crearing the random password.", e);
		}
	...
	public static void setDomainInThreadLocal(String domain) {
		if (domain != null) {
			...
			threadLocalToSetDomain.set(domain);
		}
	}
