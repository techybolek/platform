...
public final class JDBCRealmConstants {
	...
	public static final String GET_ROLE_LIST_SQL = "SELECT UM_ROLE_NAME FROM UM_ROLE WHERE UM_ROLE_NAME LIKE ? AND UM_TENANT_ID=? ORDER BY UM_ROLE_NAME";
	...
	public static final String USER_NAME_UNIQUE_SQL = "DELETE FROM UM_USER_ATTRIBUTE WHERE UM_USER_ID=(SELECT UM_ID FROM UM_USER WHERE UM_USER_NAME=? AND UM_TENANT_ID=?) AND UM_ATTR_NAME=? AND UM_PROFILE_ID=? AND UM_TENANT_ID=?";
    ...
    public static final String ADD_DOMAIN_WITH_ID_SQL = "INSERT INTO UM_DOMAIN (UM_DOMAIN_ID, UM_DOMAIN_NAME, UM_TENANT_ID) VALUES (?, ?, ?)";
    public static final String UPDATE_DOMAIN_WITH_ID_SQL = "UPDATE UM_DOMAIN SET UM_DOMAIN_NAME=? WHERE UM_DOMAIN_ID =? AND UM_TENANT_ID =?";
