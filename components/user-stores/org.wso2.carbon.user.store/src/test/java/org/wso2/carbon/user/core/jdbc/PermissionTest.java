...
public class PermissionTest extends BaseTestCase {
    ...
    public void checkPermission() throws Exception {
        ...
        authManager.authorizeUser("primary/user1", "/x1/x2", "read");
        
        assertTrue(authManager.isRoleAuthorized("primary/role1", "/x1", "read"));
        usManager.updateRoleName("role1", "role2");
        assertTrue(authManager.isRoleAuthorized("primary/role2", "/x1", "read"));
        assertFalse(authManager.isRoleAuthorized("primary/role1", "/x1", "read"));

        assertTrue(authManager.isUserAuthorized("primary/user1", "/x1/x2", "read"));
        assertTrue(authManager.isUserAuthorized("primary/user1", "/x1", "read"));
        ...
        assertTrue(authManager.isUserAuthorized("primary/bizuser", "/wso2/bizzness", "read"));
    }
