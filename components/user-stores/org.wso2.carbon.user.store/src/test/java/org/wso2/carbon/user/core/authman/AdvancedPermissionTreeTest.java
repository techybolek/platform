...
public class AdvancedPermissionTreeTest extends BaseTestCase{
    ...
    public void doAuthorizationstuff() throws Exception{
        ...
        assertTrue(authMan.isRoleAuthorized("primary/role1", "/s", "read"));
        assertTrue(authMan.isRoleAuthorized("primary/role1", "/s/t/u/v", "read"));
        assertTrue(authMan.isUserAuthorized("dimuthu","/s", "read"));
        assertTrue(authMan.isUserAuthorized("dimuthu","/s/t/u/v", "read"));

        authMan.denyRole("primary/role1", "/s/t/u", "read");
        assertFalse(authMan.isRoleAuthorized("primary/role1", "/s/t/u", "read"));
        assertFalse(authMan.isRoleAuthorized("primary/role1", "s/t/u/v/w", "read"));
        assertFalse(authMan.isUserAuthorized("dimuthu","s/t/u/v/w", "read"));
        assertTrue(authMan.isRoleAuthorized("primary/role1", "/s/t", "read")); 
        assertTrue(authMan.isUserAuthorized("dimuthu","/s/t", "read"));

        authMan.authorizeRole("primary/role1", "/s/t/u/v/w/x", "read");
        assertTrue(authMan.isRoleAuthorized("primary/role1", "/s/t/u/v/w/x/y", "read"));
        assertTrue(authMan.isRoleAuthorized("primary/role1", "/s/t", "read"));
        assertFalse(authMan.isRoleAuthorized("primary/role1", "/s/t/u/v/w", "read"));
