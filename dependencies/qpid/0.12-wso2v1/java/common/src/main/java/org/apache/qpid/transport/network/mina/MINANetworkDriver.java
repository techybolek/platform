...
public class MINANetworkDriver extends IoHandlerAdapter implements NetworkDriver
{
    ...
    public MINANetworkDriver(boolean useNIO, int processors, boolean executorPool)
    {
        _useNIO = useNIO;
    ...
    public void sessionCreated(IoSession protocolSession) throws Exception
    {
        ...
        if (_config.getIOThrottlingEnabled())
        {
        ...
        if (_acceptingConnections)
        {
            ...
            MINANetworkDriver newDriver = new MINANetworkDriver(_useNIO, _processors, _executorPool, protocolEngine, protocolSession);
