...
public class AggregationAttributeProcessor extends AbstractAggregationAttributeProcessor implements NonGroupingAttributeProcessor{
    ...
    public AggregationAttributeProcessor(Expression[] expressions, List<QueryEventStream> queryEventStreamList, AttributeAggregatorFactory attributeAggregatorFactory, String elementId, SiddhiContext siddhiContext) {
    ...
    public synchronized Object process(AtomicEvent event) {
        return process(event,aggregator);
    }
    ...
    protected Object[] currentState() {
        return new Object[]{aggregator};
    }

    @Override
    protected void restoreState(Object[] data) {
        aggregator = (Aggregator) data[0];
