...
import org.wso2.siddhi.core.util.Pair;
...
public class SchedulerTimestampQueue<T extends StreamEvent> extends SchedulerQueue<T> implements ISchedulerTimestampQueue<T> {
    ...
    public SchedulerTimestampQueue(SchedulerElement schedulerElement) {
