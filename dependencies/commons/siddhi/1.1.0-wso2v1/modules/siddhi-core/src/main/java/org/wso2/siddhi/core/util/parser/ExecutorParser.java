    ...
    public static ConditionExecutor parseCondition(Condition condition,
        ...
        if (condition instanceof AndCondition) {
            ...
            if (((Compare) condition).getOperator() == Condition.Operator.EQUAL) {
                ...
                return ComparatorParser.parseContainsCompare(parseExpression(((Compare) condition).getLeftExpression(), queryEventStreamList, currentStreamReference),
                                                             parseExpression(((Compare) condition).getRightExpression(), queryEventStreamList, currentStreamReference));
            } else if (((Compare) condition).getOperator() == Condition.Operator.INSTANCE_OF) {
                return ComparatorParser.parseInstanceOfCompare(parseExpression(((Compare) condition).getLeftExpression(), queryEventStreamList, currentStreamReference),
                                                             parseExpression(((Compare) condition).getRightExpression(), queryEventStreamList, currentStreamReference));
            }
        }
