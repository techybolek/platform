...
public class Compare extends Condition {
    ...
    @Override
    void validate(List<QueryEventStream> queryEventStreamList, String streamReferenceId) {
        ...
        ExpressionValidator.validate(rightExpression, queryEventStreamList, streamReferenceId);
        ExpressionValidator.validate(leftExpression, queryEventStreamList, streamReferenceId);
    }
}
