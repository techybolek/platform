...
//           insert into JoinStream
    ...
    public void Test4() throws RecognitionException, SiddhiPraserException {
        Query query = SiddhiCompiler.parseQuery("from TickEvent as t left outer join NewsEvent[filter.unique(symbol)]as n unidirectional \n" +
                " on t.symbol == n.symbol\n" +
                "insert into JoinStream ;");
        Assert.assertNotNull(query);
