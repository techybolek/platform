...
public class SumOutputAttributeProcessorFactory implements OutputAttributeProcessorFactory {


    @Override
    public OutputAttributeProcessor createAttributeProcessor(Attribute.Type[] types) {
        return OutputAttributeHandlerParser.createSumAggregator(types);
    }
