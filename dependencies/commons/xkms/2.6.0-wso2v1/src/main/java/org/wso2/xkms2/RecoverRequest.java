...
//                            recoverKeyBinding.getId());
                    IdResolver.registerElementById((Element) prototypeKeyBindingElement,new AttrImpl((org.apache.axiom.om.impl.dom.DocumentImpl)((Element) prototypeKeyBindingElement).getOwnerDocument(),"Id",recoverKeyBinding.getId(), OMAbstractFactory.getOMFactory()));
