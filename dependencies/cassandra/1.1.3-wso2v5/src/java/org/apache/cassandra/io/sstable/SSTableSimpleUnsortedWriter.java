...
public class SSTableSimpleUnsortedWriter extends AbstractSSTableSimpleWriter
{
    ...
    {
        currentSize += key.key.remaining() + columnFamily.serializedSize(MessagingService.version_) * 1.2;
    ...
    protected ColumnFamily getColumnFamily()
    {
        ...
        else
        {
            ...
            currentSize -= currentKey.key.remaining() + previous.serializedSize(MessagingService.version_) * 1.2;
        }
        return previous;
    }
