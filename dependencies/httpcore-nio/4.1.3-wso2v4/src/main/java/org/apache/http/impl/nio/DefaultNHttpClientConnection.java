    ...
    public void consumeInput(final NHttpClientHandler handler) {
        ...
        try {
            ...
            if (this.contentDecoder != null) {
                ...
                //TODO:Synchornized introduced as temp fix to avoid unknown NEP occurred during high load
                //but would required to provide proper fix to get better performance
                //2012-11-30
                synchronized (this) {
                	if (this.contentDecoder != null && this.contentDecoder.isCompleted()) {
