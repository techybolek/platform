...
public class BufferFactory {
    ...
    public ByteBuffer getBuffer() {
    	//TODO:removed the the implementation causes larger shared buffer related issues
    	//will have to refer perfect solution.
//        if (marker == -1) {
...
//        }
    ...
    public void release(ByteBuffer buffer) {
		// TODO:removed the original implementation due to issues identified
		// when running long test
    	 buffer.clear();
//        lock.lock();
//        try {
