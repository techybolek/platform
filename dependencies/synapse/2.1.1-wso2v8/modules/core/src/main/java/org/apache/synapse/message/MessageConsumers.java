...
public class MessageConsumers {
    /**
     * Create a new instance of the message consumer associated with the store.
     * @param messageStoreType
     * @return
     */
    public static MessageConsumer newInstance(int messageStoreType) {
        if (messageStoreType == MessageStores.JMS_MS) {
            return null;
        }
