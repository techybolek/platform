...
public class BlockingMsgSenderUtils {
    ...
    /**
     * Fill client options extracting properties from the original message context and endpoint definition
     *
    ...
    public static void fillClientOptions(EndpointDefinition endpoint, Options clientOptions,
        ...
        clientOptions.setExceptionToBeThrownOnSOAPFault("true".equals(synapseInMsgCtx.getProperty(SynapseConstants.THROW_EXCEPTION_ON_SOAPFAULT)));
    }
    ...
    public static void fillMessageContext(EndpointDefinition endpoint,
        ...
        if (preserveAddressingProperty != null && Boolean.parseBoolean(preserveAddressingProperty)) {
            ...
            MessageHelper.removeAddressingHeaders(axisOutMsgCtx);                             // TODO: check
        }
