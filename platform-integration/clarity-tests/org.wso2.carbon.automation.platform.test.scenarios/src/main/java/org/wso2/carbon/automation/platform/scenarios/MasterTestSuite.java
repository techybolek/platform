...
public class MasterTestSuite {
    ...
    public static String clarityPropertypath = null;
    public static String claritySettingsPath = null;

    public MasterTestSuite() {
        ClassLoader classLoader = Thread.currentThread().getContextClassLoader();
        URL clarityResource = classLoader.getResource("clarity.properties");
        clarityPropertypath = clarityResource.getPath();
        File resourceDir = new File(clarityPropertypath);
        claritySettingsPath = resourceDir.getParent();
