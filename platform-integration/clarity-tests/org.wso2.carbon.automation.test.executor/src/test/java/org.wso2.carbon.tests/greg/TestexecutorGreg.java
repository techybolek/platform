...
package org.wso2.carbon.tests.greg;
...
public class TestexecutorGreg extends MasterTestSuite {
    private static final Log log = LogFactory.getLog(TestexecutorGreg.class);

    @BeforeSuite
    public void execute() {
        System.setProperty("server.list", "GREG");
