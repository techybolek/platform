...
public class Context implements java.io.Serializable {
    ...
    public void setInstanceProperties(InstanceProperties nodeDetail) {
        this.instanceProperties = nodeDetail;
    }
    ...
    public void setInstanceVariables(InstanceVariables node) {
        this.productVariables = node;
    }
}
