...
public class AFSetter extends EnvironmentSetter {
    ...
    public AFSetter() {
        ...
        if (Boolean.parseBoolean(prop.getProperty("stratos.test"))) {
            hostNames = (properties.getProperty("af.service.host.name", "appfactory.stratoslive.wso2.com"));
        } else {
            hostNames = (properties.getProperty("af.host.name", "localhost"));
        }

        String httpPorts = (properties.getProperty("af.http.port", "9764"));
        String httpsPorts = (properties.getProperty("af.https.port", "9443"));
        String webContextRoots = (prop.getProperty("af.webContext.root", null));
