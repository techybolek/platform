...
public class TomcatServerManager {
    ...
    public void startJaxRsServer(String className) throws Exception {
        ...
        context.addParameter("contextConfigLocation", className);
    ...
    private File createBaseDirectory() throws IOException {
        final File base = File.createTempFile("jaxrs-tmp-", "", new File(this.getClass().getResource("jaxrs_temp").toString()));
