...
public class JMSTopicMessagePublisher {
    ...
    /**
     * This will establish  the connection with the given Topic. This must be called before calling publish()
     *
    ...
    /**
     * This will disconnect  the connection with the given Topic. This must be called after publishing the messages to release
     * the connection
     */
