...
package org.wso2.carbon.automation.api.clients.claim.mgt;

import org.apache.axis2.AxisFault;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.wso2.carbon.automation.api.clients.utils.AuthenticateStub;
import org.wso2.carbon.claim.mgt.stub.*;
import org.wso2.carbon.claim.mgt.stub.Exception;
...
public class ClaimAdminClient {
    ...
    public void addNewClaimMapping(ClaimMappingDTO claimMappingDTO)
        ...
        } catch (org.wso2.carbon.claim.mgt.stub.Exception e) {
            throw new Exception("Unable to add new claim Mapping ", e);
        }
    }
    ...
    public void removeClaimMapping(String dialectURI, String claimURI)
        ...
        try {
            ...
            throw new Exception("Unable to remove claim Mapping ", e);
        }
    }
    ...
    public ClaimDialectDTO[] getClaimMappings() throws RemoteException, Exception {
        try {
            ...
            throw new Exception("Error while getting claim mappings ", e);
        }
    }
}
