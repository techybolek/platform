class stratos::appserver ( $version, 
		   $offset=0, 
		   $tribes_port=4000, 
	...
	$service_templates 	=  $sub_cluster_domain ? {
                                        "mgt" =>    ["conf/registry.xml","conf/axis2/axis2.xml","conf/carbon.xml","conf/security/authenticators.xml", 
						     "conf/etc/bam.xml", "deployment/server/webapps/STRATOS_ROOT/index.html"],
                                        "worker" => ["conf/registry.xml","conf/axis2/axis2.xml","conf/carbon.xml","conf/security/authenticators.xml", 
						     "conf/etc/bam.xml"],
                                  }

        $common_templates      =  ["conf/etc/cache.xml","conf/multitenancy/cloud-services-desc.xml", "conf/datasources/master-datasources.xml",
				   "conf/identity.xml","conf/user-mgt.xml","conf/etc/logging-config.xml","conf/multitenancy/stratos.xml", "conf/log4j.properties"]
